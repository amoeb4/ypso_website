...
//#endregion
//#region node_modules/tailwindcss/dist/chunk-HMCCH6MG.mjs
var S$1 = new Set([
	"black",
	"silver",
	"gray",
...
function N(e) {
	return e.charCodeAt(0) === 35 || U$1.test(e) || S$1.has(e.toLowerCase());
}
function oe$1(e) {
	return S$1.has(e.toLowerCase());
}
var A = [
	"calc",
	"min",
...
function at(e) {
	...
	function t({ line: n, column: s }) {
		...
		let l = i[n], p = i[n + 1] ?? l;
		return Math.min(Math.max(l + s, 0), p);
	}
	return {
		find: r,
		findOffset: t
...
var Ye = 92, st = 47, ut = 42, gr = 34, hr = 39, ln = 58, ft = 59, de = 10, ct = 13, Ge = 32, qe = 9, vr = 123, Pt = 125, It = 40, wr = 41, on = 91, an = 93, yr = 45, Ot = 64, sn = 33, me = class e extends Error {
	loc;
	constructor(i, r) {
		if (r) {
...
function Se(e, i) {
	...
	e[0] === "﻿" && (e = " " + e.slice(1));
	let t = [], n = [], s = [], l = null, p = null, f = "", c = "", m = 0, d;
	for (let u = 0; u < e.length; u++) {
		let h = e.charCodeAt(u);
		if (!(h === ct && (d = e.charCodeAt(u + 1), d === de))) if (h === Ye) f === "" && (m = u), f += e.slice(u, u + 2), u += 1;
		else if (h === st && e.charCodeAt(u + 1) === ut) {
			let v = u;
			for (let b = u + 2; b < e.length; b++) if (d = e.charCodeAt(b), d === Ye) b += 1;
			else if (d === ut && e.charCodeAt(b + 1) === st) {
				u = b + 1;
				break;
			}
			let y = e.slice(v, u + 1);
			if (y.charCodeAt(2) === sn) {
				let b = pt(y.slice(2, -2));
				n.push(b), r && (b.src = [
					r,
					v,
					u + 1
			...
			if ((h === Ge || h === de || h === qe) && (d = e.charCodeAt(u + 1)) && (d === Ge || d === de || d === qe || d === ct && (d = e.charCodeAt(u + 2)) && d == de)) continue;
			if (h === de) {
				if (f.length === 0) continue;
				d = f.charCodeAt(f.length - 1), d !== Ge && d !== de && d !== qe && (f += " ");
			} else if (h === yr && e.charCodeAt(u + 1) === yr && f.length === 0) {
				let v = "", y = u, b = -1;
				for (let A = u + 2; A < e.length; A++) if (d = e.charCodeAt(A), d === Ye) A += 1;
				else if (d === hr || d === gr) A = kr(e, A, d, r);
				else if (d === st && e.charCodeAt(A + 1) === ut) {
					for (let k = A + 2; k < e.length; k++) if (d = e.charCodeAt(k), d === Ye) k += 1;
					else if (d === ut && e.charCodeAt(k + 1) === st) {
						A = k + 1;
						break;
					}
				} else if (b === -1 && d === ln) b = f.length + A - y;
				else if (d === ft && v.length === 0) {
					f += e.slice(y, A), u = A;
					break;
				} else if (d === It) v += ")";
				else if (d === on) v += "]";
				else if (d === vr) v += "}";
				else if ((d === Pt || e.length - 1 === A) && v.length === 0) {
					u = A - 1, f += e.slice(y, A);
					break;
				} else (d === wr || d === an || d === Pt) && v.length > 0 && e[A] === v[v.length - 1] && (v = v.slice(0, -1));
				let N = _t(f, b);
				if (!N) throw new me("Invalid custom property, expected a value", r ? [
					r,
					y,
					u
				] : null);
				r && (N.src = [
					...
					y,
					u
				]), l ? l.nodes.push(N) : t.push(N), f = "";
			} else if (h === ft && f.charCodeAt(0) === Ot) p = He(f), r && (p.src = [
				r,
				m,
				u
			], p.dst = [
				...
				m,
				u
			]), l ? l.nodes.push(p) : t.push(p), f = "", p = null;
			else if (h === ft && c[c.length - 1] !== ")") {
				let v = _t(f);
				if (!v) {
					if (f.length === 0) continue;
					throw new me(`Invalid declaration: \`${f.trim()}\``, r ? [
						r,
						m,
						u
					] : null);
				...
				r && (v.src = [
					...
					m,
					u
				]), l ? l.nodes.push(v) : t.push(v), f = "";
			} else if (h === vr && c[c.length - 1] !== ")") c += "}", p = J(f.trim()), r && (p.src = [
				r,
				m,
				u
			], p.dst = [
				...
				m,
				u
			]), l && l.nodes.push(p), s.push(l), l = p, f = "", p = null;
			else if (h === Pt && c[c.length - 1] !== ")") {
				if (c === "") throw new me("Missing opening {", r ? [
					r,
					u,
					u
				] : null);
				if (c = c.slice(0, -1), f.length > 0) if (f.charCodeAt(0) === Ot) p = He(f), r && (p.src = [
					r,
					m,
					u
				], p.dst = [
					...
					if (l) {
						let b = _t(f, y);
						if (!b) throw new me(`Invalid declaration: \`${f.trim()}\``, r ? [
							r,
							m,
							u
						] : null);
				...
				let v = s.pop() ?? null;
				v === null && l && t.push(l), l = v, f = "", p = null;
			} else if (h === It) c += ")", f += "(";
			else if (h === wr) {
				if (c[c.length - 1] !== ")") throw new me("Missing opening (", r ? [
					r,
					u,
					u
				] : null);
				...
				if (f.length === 0 && (h === Ge || h === de || h === qe)) continue;
				f === "" && (m = u), f += String.fromCharCode(h);
			}
		}
	}
	if (f.charCodeAt(0) === Ot) {
		let u = He(f);
		r && (u.src = [
			r,
			m,
	...
	if (c.length > 0 && l) {
		if (l.kind === "rule") throw new me(`Missing closing } at ${l.selector}`, l.src ? [
			l.src[0],
			l.src[1],
			l.src[1]
		] : null);
		if (l.kind === "at-rule") throw new me(`Missing closing } at ${l.name} ${l.params}`, l.src ? [
			l.src[0],
			l.src[1],
			l.src[1]
		] : null);
...
function _t(e, i = e.indexOf(":")) {
	if (i === -1) return null;
	let r = e.indexOf("!important", i + 1);
	return o(e.slice(0, i).trim(), e.slice(i + 1, r === -1 ? e.length : r).trim(), r !== -1);
}
function kr(e, i, r, t = null) {
	let n;
	for (let s = i + 1; s < e.length; s++) if (n = e.charCodeAt(s), n === Ye) s += 1;
	else {
		if (n === r) return s;
		if (n === ft && (e.charCodeAt(s + 1) === de || e.charCodeAt(s + 1) === ct && e.charCodeAt(s + 2) === de)) throw new me(`Unterminated string: ${e.slice(i, s + 1) + String.fromCharCode(r)}`, t ? [
			t,
			i,
			s + 1
		] : null);
		if (n === de || n === ct && e.charCodeAt(s + 1) === de) throw new me(`Unterminated string: ${e.slice(i, s) + String.fromCharCode(r)}`, t ? [
			t,
			i,
			s + 1
		] : null);
...
var br = 92, cn = 41, xr = 58, Ar = 44, pn = 34, Cr = 61, Vr = 62, Sr = 60, $r = 10, dn = 40, mn = 39, gn = 47, Tr = 32, Nr = 9;
function M(e) {
	e = e.replaceAll(`\r
`, `
`);
	...
	for (let l = 0; l < e.length; l++) {
		...
		switch (p) {
			...
			case Nr: {
				if (n.length > 0) {
					let d = ne(n);
					t ? t.nodes.push(d) : i.push(d), n = "";
				}
				let f = l, c = l + 1;
				for (; c < e.length && (s = e.charCodeAt(c), !(s !== xr && s !== Ar && s !== Cr && s !== Vr && s !== Sr && s !== $r && s !== Tr && s !== Nr)); c++);
				l = c - 1;
				let m = fn(e.slice(f, c));
			...
			case pn: {
				let f = l;
				for (let c = l + 1; c < e.length; c++) if (s = e.charCodeAt(c), s === br) c += 1;
				else if (s === p) {
					l = c;
					break;
				}
...
var Kt = ((l) => (l[l.Continue = 0] = "Continue", l[l.Skip = 1] = "Skip", l[l.Stop = 2] = "Stop", l[l.Replace = 3] = "Replace", l[l.ReplaceSkip = 4] = "ReplaceSkip", l[l.ReplaceStop = 5] = "ReplaceStop", l))(Kt || {}), V = {
	Continue: { kind: 0 },
	Skip: { kind: 1 },
	Stop: { kind: 2 },
	Replace: (e) => ({
...
function _(e, i) {
	typeof i == "function" ? Er(e, i) : Er(e, i.enter, i.exit);
}
function Er(e, i = () => V.Continue, r = () => V.Continue) {
	let t = {
		value: [
			e,
			0,
	...
	for (; t !== null;) {
		let s = t.value, l = s[0], p = s[1], f = s[2];
		if (p >= l.length) {
			t = t.prev, n.depth -= 1;
			continue;
		}
		if (n.parent = f, n.siblings = l, p >= 0) {
			n.index = p;
			let u = l[p], h = i(u, n) ?? V.Continue;
			switch (h.kind) {
				case 0:
				...
				case 1:
					...
					continue;
				case 3:
					l.splice(p, 1, ...h.nodes);
					continue;
				case 5:
					l.splice(p, 1, ...h.nodes);
					return;
				case 4:
					l.splice(p, 1, ...h.nodes), s[1] += h.nodes.length;
					continue;
				default: throw new Error(`Invalid \`WalkAction.${Kt[h.kind] ?? `Unknown(${h.kind})`}\` in enter.`);
			}
		}
		let c = ~p;
		n.index = c;
		let m = l[c], d = r(m, n) ?? V.Continue;
		switch (d.kind) {
			case 0:
				s[1] = c + 1;
				continue;
			case 2: return;
			case 3:
				l.splice(c, 1, ...d.nodes), s[1] = c + d.nodes.length;
				continue;
			case 5:
				l.splice(c, 1, ...d.nodes);
				return;
			case 4:
				l.splice(c, 1, ...d.nodes), s[1] = c + d.nodes.length;
				continue;
			default: throw new Error(`Invalid \`WalkAction.${Kt[d.kind] ?? `Unknown(${d.kind})`}\` in exit.`);
		}
	}
}
function dt(e) {
	let i = [];
	return _(M(e), (r) => {
		if (!(r.kind !== "function" || r.value !== "var")) return _(r.nodes, (t) => {
...
function J(e, i = []) {
	return e.charCodeAt(0) === hn ? He(e, i) : H(e, i);
}
function o(e, i, r = !1) {
	return {
		kind: "declaration",
...
function $e(e, i, r = 3) {
	let t = [], n = /* @__PURE__ */ new Set(), s = new U(() => /* @__PURE__ */ new Set()), l = new U(() => /* @__PURE__ */ new Set()), p = /* @__PURE__ */ new Set(), f = /* @__PURE__ */ new Set(), c = [], m = [], d = new U(() => /* @__PURE__ */ new Set());
	function u(v, y, b = {}, N = 0) {
		if (v.kind === "declaration") {
			if (v.property === "--tw-sort" || v.value === void 0 || v.value === null) return;
			if (b.theme && v.property[0] === "-" && v.property[1] === "-") {
				if (v.value === "initial") {
					v.value = void 0;
					return;
				}
				b.keyframes || s.get(y).add(v);
			}
			if (v.value.includes("var(")) if (b.theme && v.property[0] === "-" && v.property[1] === "-") for (let A of dt(v.value)) d.get(A).add(v.property);
			else i.trackUsedVariables(v.value);
			if (v.property === "animation") for (let A of Rr(v.value)) f.add(A);
			r & 2 && v.value.includes("color-mix(") && !b.supportsColorMix && !b.keyframes && l.get(y).add(v), y.push(v);
		} else if (v.kind === "rule") {
			let A = [];
			for (let O of v.nodes) u(O, A, b, N + 1);
			let k = {}, D = /* @__PURE__ */ new Set();
			for (let O of A) {
				if (O.kind !== "declaration") continue;
				let P = `${O.property}:${O.value}:${O.important}`;
				k[P] ??= [], k[P].push(O);
			}
			for (let O in k) for (let P = 0; P < k[O].length - 1; ++P) D.add(k[O][P]);
			if (D.size > 0 && (A = A.filter((O) => !D.has(O))), A.length === 0) return;
			v.selector === "&" ? y.push(...A) : y.push({
				...v,
				nodes: A
			});
			...
			if (r & 1) {
				let k = v.params, D = null, O = !1;
				for (let z of v.nodes) z.kind === "declaration" && (z.property === "initial-value" ? D = z.value : z.property === "inherits" && (O = z.value === "true"));
				let P = o(k, D ?? "initial");
				P.src = v.src, O ? c.push(P) : m.push(P);
			}
			n.add(v.params);
			let A = {
				...v,
			...
			for (let k of v.nodes) u(k, A.nodes, b, N + 1);
			y.push(A);
		} else if (v.kind === "at-rule") {
			v.name === "@keyframes" ? b = {
				...b,
				keyframes: !0
			} : v.name === "@supports" && v.params.includes("color-mix(") && (b = {
				...b,
				supportsColorMix: !0
			});
			let A = {
			...
			for (let k of v.nodes) u(k, A.nodes, b, N + 1);
			v.name === "@keyframes" && b.theme && p.add(A), (A.nodes.length > 0 || A.name === "@layer" || A.name === "@charset" || A.name === "@custom-media" || A.name === "@namespace" || A.name === "@import" || A.name === "@apply") && y.push(A);
		} else if (v.kind === "at-root") for (let A of v.nodes) {
			let k = [];
			u(A, k, b, 0);
			for (let D of k) t.push(D);
		}
		else if (v.kind === "context") {
			if (v.context.reference) return;
			for (let A of v.nodes) u(A, y, {
				...b,
				...v.context
			}, N);
		} else v.kind === "comment" && y.push(v);
	}
	let h = [];
	for (let v of e) u(v, h, {}, 0);
	e: for (let [v, y] of s) for (let b of y) {
		if (Pr(b.property, i.theme, d)) {
			if (b.property.startsWith(i.theme.prefixKey("--animate-"))) for (let k of Rr(b.value)) f.add(k);
			continue;
		}
		let A = v.indexOf(b);
		if (v.splice(A, 1), v.length === 0) {
			let k = vn(h, (D) => D.kind === "rule" && D.nodes === v);
	...
	if (h = h.concat(t), r & 2) for (let [v, y] of l) for (let b of y) {
		let N = v.indexOf(b);
		if (N === -1 || b.value == null) continue;
		let A = M(b.value), k = !1;
		if (_(A, (P) => {
			...
			if (_(P.nodes, (j) => {
				...
				do {
					...
					if (ee.add(a), k = !0, G = i.theme.resolveValue(null, [ie.value]), !G) {
						z = !0;
						return;
					}
				...
				let j = P.nodes.findIndex((G) => G.kind === "separator" && G.value.trim().includes(","));
				if (j === -1) return;
				let q = P.nodes.length > j ? P.nodes[j + 1] : null;
		...
		let D = {
			...b,
			value: F(A)
		}, O = J("@supports (color: color-mix(in lab, red, red))", [b]);
		O.src = b.src, v.splice(N, 1, D, O);
	}
	if (r & 1) {
		let v = [];
		if (c.length > 0) {
			let y = J(":root, :host", c);
			y.src = c[0].src, v.push(y);
		}
		if (m.length > 0) {
			let y = J("*, ::before, ::after, ::backdrop", m);
			y.src = m[0].src, v.push(y);
		}
		if (v.length > 0) {
			let y = h.findIndex((A) => !(A.kind === "comment" || A.kind === "at-rule" && (A.name === "@charset" || A.name === "@import"))), b = B("@layer", "properties", []);
			b.src = v[0].src, h.splice(y < 0 ? h.length : y, 0, b);
			let N = J("@layer properties", [B("@supports", "((-webkit-hyphens: none) and (not (margin-trim: inline))) or ((-moz-orient: inline) and (not (color:rgb(from red r g b))))", v)]);
			N.src = v[0].src, N.nodes[0].src = v[0].src, h.push(N);
		}
	}
	return h;
}
...
`, i) {
			...
			for (let m of l.nodes) f += n(m, p + 1);
			f += `${c}}
`, i && (r += c.length, r += 2);
...
function Pr(e, i, r, t = /* @__PURE__ */ new Set()) {
			...
			if (i.value === "var" || i.value.endsWith("_var") || i.value === "theme" || i.value.endsWith("_theme")) {
				...
				for (let r = 0; r < i.nodes.length; r++) {
					if (r == 0 && i.nodes[r].kind === "word") {
						i.nodes[r].value = Ie(i.nodes[r].value, !0);
						continue;
					}
					zt([i.nodes[r]]);
				}
...
var yn = 58, Or = 45, _r = 97, Ir = 122, Ft = /^[a-zA-Z0-9_.%-]+$/;
function Ke(e) {
	switch (e.kind) {
...
function* Dr(e, i) {
	...
	let [l, p = null, f] = d(t, "/");
	if (f) return;
	let c = p === null ? null : jt(p);
	if (p !== null && c === null) return;
	if (l[0] === "[") {
		if (l[l.length - 1] !== "]") return;
		let d = l.charCodeAt(1);
		if (d !== Or && !(d >= _r && d <= Ir)) return;
		l = l.slice(1, -1);
		let u = l.indexOf(":");
		if (u === -1 || u === 0 || u === l.length - 1) return;
		let h = l.slice(0, u), v = be(l.slice(u + 1));
		if (!ye(v)) return;
		yield {
			kind: "arbitrary",
			property: h,
	...
	if (l[l.length - 1] === "]") {
		...
		let u = l.slice(0, d$1);
		if (!i.utilities.has(u, "functional")) return;
		let h = l.slice(d$1 + 2, -1), v = d(h, ":"), y = null;
		if (v.length === 2 && (y = v[0], h = v[1]), h[0] !== "-" || h[1] !== "-" || !ye(h)) return;
		m = [[u, y === null ? `[var(${h})]` : `[${y}:var(${h})]`]];
	} else m = Ur(l, (d) => i.utilities.has(d, "functional"));
	for (let [d, u] of m) {
		let h = {
			kind: "functional",
			root: d,
		...
		}
		{
			...
			if (v !== -1) {
				...
				let b = be(u.slice(v + 1, -1));
				if (!ye(b)) continue;
				let N = null;
				for (let A = 0; A < b.length; A++) {
					let k = b.charCodeAt(A);
					if (k === yn) {
						N = b.slice(0, A), b = b.slice(A + 1);
						break;
					}
					if (!(k === Or || k >= _r && k <= Ir)) break;
				}
				if (b.length === 0 || b.trim().length === 0 || N === "") continue;
				h.value = {
					kind: "arbitrary",
					dataType: N || null,
					value: b
				...
				let b = p === null || h.modifier?.kind === "arbitrary" ? null : `${u}/${p}`;
				if (!Ft.test(u)) continue;
				h.value = {
					kind: "named",
					value: u,
					fraction: b
...
function Kr(e, i) {
	...
	}
	{
		let [r, t = null, n] = d(e, "/");
		if (n) return null;
		let s = Ur(r, (l) => i.variants.has(l));
		for (let [l, p] of s) switch (i.variants.kind(l)) {
			case "static": return p !== null || t !== null ? null : {
				kind: "static",
				root: l
			};
			case "functional": {
				let f = t === null ? null : jt(t);
			...
			case "compound": {
				...
				t && (l === "not" || l === "has" || l === "in") && (p = `${p}/${t}`, t = null);
				let f = i.parseVariant(p);
...
function zr(e, i) {
	...
	if (i.kind === "static" && (t += i.root), i.kind === "functional" && (t += i.root, i.value)) if (i.value.kind === "arbitrary") {
		if (i.value !== null) {
			let n = Wt(i.value.value), s = n ? i.value.value.slice(4, -1) : i.value.value, [l, p] = n ? ["(", ")"] : ["[", "]"];
			i.value.dataType ? t += `-${l}${i.value.dataType}:${xe(s)}${p}` : t += `-${l}${xe(s)}${p}`;
		}
	} else i.value.kind === "named" && (t += `-${i.value.value}`);
	return i.kind === "arbitrary" && (t += `[${i.property}:${xe(i.value)}]`), (i.kind === "arbitrary" || i.kind === "functional") && (t += Xe(i.modifier)), i.important && (t += "!"), r.push(t), r.join(":");
}
function Xe(e) {
	if (e === null) return "";
	let i = Wt(e.value), r = i ? e.value.slice(4, -1) : e.value, [t, n] = i ? ["(", ")"] : ["[", "]"];
	return e.kind === "arbitrary" ? `/${t}${xe(r)}${n}` : e.kind === "named" ? `/${e.value}` : "";
}
function mt(e) {
	if (e.kind === "static") return e.root;
	if (e.kind === "arbitrary") return `[${xe(xn(e.selector))}]`;
	let i = "";
	if (e.kind === "functional") {
		i += e.root;
		let r = e.root !== "@";
		if (e.value) if (e.value.kind === "arbitrary") {
			let t = Wt(e.value.value), n = t ? e.value.value.slice(4, -1) : e.value.value, [s, l] = t ? ["(", ")"] : ["[", "]"];
			i += `${r ? "-" : ""}${s}${xe(n)}${l}`;
		} else e.value.kind === "named" && (i += `${r ? "-" : ""}${e.value.value}`);
	}
	return e.kind === "compound" && (i += e.root, i += "-", i += mt(e.variant)), (e.kind === "functional" || e.kind === "compound") && (i += Xe(e.modifier)), i;
}
var kn = new U((e) => {
...
function Mt(e) {
	for (let i of e) switch (i.kind) {
		case "function":
			...
			i.value = Qe(i.value), Mt(i.nodes);
			break;
		case "separator":
			i.value = Qe(i.value);
			break;
		case "word":
			(i.value[0] !== "-" || i.value[1] !== "-") && (i.value = Qe(i.value));
			break;
		default: Cn(i);
	}
}
...
function Te(e, i, r) {
	if (e === i) return 0;
	let t = e.indexOf("("), n = i.indexOf("("), s = t === -1 ? e.replace(/[\d.]+/g, "") : e.slice(0, t), l = n === -1 ? i.replace(/[\d.]+/g, "") : i.slice(0, n), p = (s === l ? 0 : s < l ? -1 : 1) || (r === "asc" ? parseInt(e) - parseInt(i) : parseInt(i) - parseInt(e));
	return Number.isNaN(p) ? e < i ? -1 : 1 : p;
}
var Vn = /^(?<value>[-+]?(?:\d*\.)?\d+)(?<unit>[a-z]+|%)?$/i, le = new U((e) => {
	let i = Vn.exec(e);
	if (!i) return null;
...
function et(e, i) {
	...
	return d(e, ",").map((n) => {
		n = n.trim();
		let s = M(n), l = null, p = 0, f = 0, c = !1;
		return _(s, (m) => {
			switch (m.kind) {
				case "word":
					if (Sn.has(m.value.toLowerCase())) return V.Continue;
					if (Nn.test(m.value.toLowerCase())) return f++, V.Continue;
					if (m.value[0] === "#" || oe$1(m.value)) return c = !0, V.ReplaceStop(r(m));
					l = m, p++;
					break;
				case "function": return Tn.has(m.value.toLowerCase()) ? (c = !0, V.ReplaceStop(r(m))) : $n.has(m.value.toLowerCase()) ? (f++, V.Skip) : (l = m, p++, V.Skip);
				case "separator": return V.Continue;
				default:
			}
		}), c ? F(s) : f < 2 ? n : p === 0 ? `${n} ${i("currentcolor")}` : (p === 1 && _(s, (m) => m === l ? (c = !0, V.ReplaceStop(r(m))) : V.Skip), c ? F(s) : n);
	}).join(", ");
}
var wt = [
	"0",
...
function Fr(e) {
	...
	function r(a, g) {
		function* w(x) {
			for (let $ of e.keysInNamespaces(x)) yield $.replace(Mr, (K, T, R) => `${T}.${R}`);
		}
		let C = [
			"1/2",
			"1/3",
		...
		i.suggest(a, () => {
			...
			for (let $ of g()) {
				...
				let K = [...$.values ?? [], ...w($.valueThemeKeys ?? [])], T = [...$.modifiers ?? [], ...w($.modifierThemeKeys ?? [])];
				$.supportsFractions && K.push(...C), $.hasDefaultValue && K.unshift(null), x.push({
	...
	function t(a, g) {
		i.static(a, () => g.map((w) => typeof w == "function" ? w() : o(w[0], w[1])));
	}
	function n(a, g) {
		...
		function w({ negative: C }) {
			return (x) => {
				...
				if (x.value) if (x.value.kind === "arbitrary") {
					...
					$ = x.value.value, K = x.value.dataType;
				} else {
					if ($ = e.resolve(x.value.fraction ?? x.value.value, g.themeKeys ?? []), $ === null && g.supportsFractions && x.value.fraction) {
						let [T, R] = d(x.value.fraction, "/");
						if (!u(T) || !u(R)) return;
						$ = `calc(${T} / ${R} * 100%)`;
					}
					if ($ === null && C && g.handleNegativeBareValue) {
						if ($ = g.handleNegativeBareValue(x.value), !$?.includes("/") && x.modifier) return;
						if ($ !== null) return g.handle($, null);
					}
					if ($ === null && g.handleBareValue && ($ = g.handleBareValue(x.value), !$?.includes("/") && x.modifier)) return;
					if ($ === null && !C && g.staticValues && !x.modifier) {
						let T = g.staticValues[x.value.value];
						if (T) return T.map(re);
					}
				}
				else {
					if (x.modifier) return;
					$ = g.defaultValue !== void 0 ? g.defaultValue : e.resolve(null, g.themeKeys ?? []);
				}
				if ($ !== null) return g.handle(C ? ae$1(`calc(${$} * -1)`) : $, K);
			};
		}
		if (g.supportsNegative && i.functional(`-${a}`, w({ negative: !0 })), i.functional(a, w({ negative: !1 })), r(a, () => [{
	...
	function s(a, g) {
		i.functional(a, (w) => {
			if (!w.value) return;
			let C = null;
			if (w.value.kind === "arbitrary" ? (C = w.value.value, C = te(C, w.modifier, e)) : C = oe(w, e, g.themeKeys), C !== null) return g.handle(C);
		}), r(a, () => [{
			values: [
				"current",
				"inherit",
	...
	function l(a, g, w, { supportsNegative: C = !1, supportsFractions: x = !1, staticValues: $ } = {}) {
		C && i.static(`-${a}-px`, () => w("-1px")), i.static(`${a}-px`, () => w("1px")), n(a, {
			themeKeys: g,
			supportsFractions: x,
			supportsNegative: C,
			defaultValue: null,
	...
	for (let [a, g] of [
		...
		["bottom", "bottom"],
		["left", "left"]
	]) t(`${a}-auto`, [[g, "auto"]]), t(`${a}-full`, [[g, "100%"]]), t(`-${a}-full`, [[g, "-100%"]]), l(a, ["--inset", "--spacing"], (w) => [o(g, w)], {
		supportsNegative: !0,
		supportsFractions: !0
	});
	t("isolate", [["isolation", "isolate"]]), t("isolation-auto", [["isolation", "auto"]]), n("z", {
		...
		supportsNegative: !0,
		values: Array.from({ length: 13 }, (a, g) => `${g + 1}`),
	...
	for (let [a, g] of [
		...
		["mb", "margin-bottom"],
		["ml", "margin-left"]
	]) t(`${a}-auto`, [[g, "auto"]]), l(a, ["--margin", "--spacing"], (w) => [o(g, w)], { supportsNegative: !0 });
	t("box-border", [["box-sizing", "border-box"]]), t("box-content", [["box-sizing", "content-box"]]), n("line-clamp", {
		...
		handleBareValue: ({ fraction: a }) => {
			...
			let [g, w] = d(a, "/");
			return !de$1(g) || !de$1(w) ? null : a;
		},
		handle: (a) => [o("aspect-ratio", a)],
		staticValues: {
	...
	for (let [a, g] of [
		...
		["width", g],
		["height", g]
	]), t(`w-${a}`, [["width", g]]), t(`h-${a}`, [["height", g]]), t(`min-w-${a}`, [["min-width", g]]), t(`min-h-${a}`, [["min-height", g]]), t(`max-w-${a}`, [["max-width", g]]), t(`max-h-${a}`, [["max-height", g]]);
	t("size-auto", [
		["--tw-sort", "size"],
		["width", "auto"],
		["height", "auto"]
	]), t("w-auto", [["width", "auto"]]), t("h-auto", [["height", "auto"]]), t("min-w-auto", [["min-width", "auto"]]), t("min-h-auto", [["min-height", "auto"]]), t("h-lh", [["height", "1lh"]]), t("min-h-lh", [["min-height", "1lh"]]), t("max-h-lh", [["max-height", "1lh"]]), t("w-screen", [["width", "100vw"]]), t("min-w-screen", [["min-width", "100vw"]]), t("max-w-screen", [["max-width", "100vw"]]), t("h-screen", [["height", "100vh"]]), t("min-h-screen", [["min-height", "100vh"]]), t("max-h-screen", [["max-height", "100vh"]]), t("max-w-none", [["max-width", "none"]]), t("max-h-none", [["max-height", "none"]]), l("size", ["--size", "--spacing"], (a) => [
		o("--tw-sort", "size"),
		o("width", a),
		o("height", a)
	], { supportsFractions: !0 });
	...
	]) l(a, g, (C) => [o(w, C)], { supportsFractions: !0 });
	for (let [a, g] of [
		["full", "100%"],
		["min", "min-content"],
		["max", "max-content"],
		["fit", "fit-content"]
	]) t(`inline-${a}`, [["inline-size", g]]), t(`block-${a}`, [["block-size", g]]), t(`min-inline-${a}`, [["min-inline-size", g]]), t(`min-block-${a}`, [["min-block-size", g]]), t(`max-inline-${a}`, [["max-inline-size", g]]), t(`max-block-${a}`, [["max-block-size", g]]);
	for (let [a, g] of [
		["svw", "100svw"],
		["lvw", "100lvw"],
		["dvw", "100dvw"]
	]) t(`inline-${a}`, [["inline-size", g]]), t(`min-inline-${a}`, [["min-inline-size", g]]), t(`max-inline-${a}`, [["max-inline-size", g]]);
	for (let [a, g] of [
		["svh", "100svh"],
		["lvh", "100lvh"],
		["dvh", "100dvh"]
	]) t(`block-${a}`, [["block-size", g]]), t(`min-block-${a}`, [["min-block-size", g]]), t(`max-block-${a}`, [["max-block-size", g]]);
	...
	i.static("container", () => {
		...
		return g;
	}), t("flex-auto", [["flex", "auto"]]), t("flex-initial", [["flex", "0 auto"]]), t("flex-none", [["flex", "none"]]), i.functional("flex", (a) => {
		if (a.value) {
			if (a.value.kind === "arbitrary") return a.modifier ? void 0 : [o("flex", a.value.value)];
			if (a.value.fraction) {
				let [g, w] = d(a.value.fraction, "/");
				return !u(g) || !u(w) ? void 0 : [o("flex", `calc(${a.value.fraction} * 100%)`)];
			}
			if (u(a.value.value)) return a.modifier ? void 0 : [o("flex", a.value.value)];
		}
	}), r("flex", () => [{ supportsFractions: !0 }, { values: Array.from({ length: 12 }, (a, g) => `${g + 1}`) }]), n("shrink", {
		defaultValue: "1",
		handleBareValue: ({ value: a }) => u(a) ? a : null,
		handle: (a) => [o("flex-shrink", a)]
	}), n("grow", {
		defaultValue: "1",
		handleBareValue: ({ value: a }) => u(a) ? a : null,
		handle: (a) => [o("flex-grow", a)]
	}), r("shrink", () => [{
		values: ["0"],
		valueThemeKeys: [],
		hasDefaultValue: !0
		...
		"--spacing",
		"--container"
	], (a) => [o("flex-basis", a)], { supportsFractions: !0 }), t("table-auto", [["table-layout", "auto"]]), t("table-fixed", [["table-layout", "fixed"]]), t("caption-top", [["caption-side", "top"]]), t("caption-bottom", [["caption-side", "bottom"]]), t("border-collapse", [["border-collapse", "collapse"]]), t("border-separate", [["border-collapse", "separate"]]);
	let p = () => Y([S("--tw-border-spacing-x", "0", "<length>"), S("--tw-border-spacing-y", "0", "<length>")]);
	l("border-spacing", ["--border-spacing", "--spacing"], (a) => [
		p(),
		o("--tw-border-spacing-x", a),
		o("--tw-border-spacing-y", a),
		o("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")
	]), l("border-spacing-x", ["--border-spacing", "--spacing"], (a) => [
		p(),
		o("--tw-border-spacing-x", a),
		o("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")
	]), l("border-spacing-y", ["--border-spacing", "--spacing"], (a) => [
		p(),
		o("--tw-border-spacing-y", a),
		o("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)")
	]), n("origin", {
		themeKeys: ["--transform-origin"],
		handle: (a) => [o("transform-origin", a)],
		staticValues: {
		...
		handle: (a) => [o("perspective-origin", a)],
		staticValues: {
	...
	t("translate-none", [["translate", "none"]]), t("-translate-full", [
		...
		["--tw-translate-y", "100%"],
		["translate", "var(--tw-translate-x) var(--tw-translate-y)"]
	]), l("translate", ["--translate", "--spacing"], (a) => [
		f(),
		o("--tw-translate-x", a),
		o("--tw-translate-y", a),
	...
	for (let a of ["x", "y"]) t(`-translate-${a}-full`, [
		f,
		[`--tw-translate-${a}`, "-100%"],
		["translate", "var(--tw-translate-x) var(--tw-translate-y)"]
	]), t(`translate-${a}-full`, [
		...
		[`--tw-translate-${a}`, "100%"],
		["translate", "var(--tw-translate-x) var(--tw-translate-y)"]
	]), l(`translate-${a}`, ["--translate", "--spacing"], (g) => [
		f(),
		o(`--tw-translate-${a}`, g),
		o("translate", "var(--tw-translate-x) var(--tw-translate-y)")
	], {
	...
	l("translate-z", ["--translate", "--spacing"], (a) => [
		f(),
		o("--tw-translate-z", a),
	...
	function m({ negative: a }) {
		return (g) => {
			...
			let w;
			return g.value.kind === "arbitrary" ? (w = g.value.value, w = a ? `calc(${w} * -1)` : w, [o("scale", w)]) : (w = e.resolve(g.value.value, ["--scale"]), !w && u(g.value.value) && (w = `${g.value.value}%`), w ? (w = a ? `calc(${w} * -1)` : w, [
				c(),
				o("--tw-scale-x", w),
				o("--tw-scale-y", w),
				o("--tw-scale-z", w),
	...
	i.functional("-scale", m({ negative: !0 })), i.functional("scale", m({ negative: !1 })), r("scale", () => [{
		supportsNegative: !0,
		values: [
			"0",
			"50",
	...
	function d$2({ negative: a }) {
		return (g) => {
			...
			if (g.value.kind === "arbitrary") {
				...
				if (C === "vector") return [o("rotate", `${w} var(--tw-rotate)`)];
				if (C !== "angle") return [o("rotate", a ? `calc(${w} * -1)` : w)];
			} else if (w = e.resolve(g.value.value, ["--rotate"]), !w && u(g.value.value) && (w = `${g.value.value}deg`), !w) return;
			return [o("rotate", a ? `calc(${w} * -1)` : w)];
		};
	}
	i.functional("-rotate", d$2({ negative: !0 })), i.functional("rotate", d$2({ negative: !1 })), r("rotate", () => [{
		supportsNegative: !0,
		values: [
			"0",
			"1",
	...
	}]);
	{
		...
		for (let w of [
			...
			handle: (C) => [
				g(),
				o(`--tw-rotate-${w}`, `rotate${w.toUpperCase()}(${C})`),
				o("transform", a)
			]
		}), r(`rotate-${w}`, () => [{
			supportsNegative: !0,
		...
		n("skew", {
			...
			let C = null;
			if (w.value ? w.value.kind === "arbitrary" && (C = w.value.value) : C = a, C !== null) return [g(), o("transform", C)];
		}), r("transform", () => [{ hasDefaultValue: !0 }]), t("transform-cpu", [["transform", a]]), t("transform-gpu", [["transform", `translateZ(0) ${a}`]]), t("transform-none", [["transform", "none"]]);
	}
	n("zoom", {
		handleBareValue: ({ value: a }) => u(a) ? `${a}%` : null,
		handle: (a) => [o("zoom", a)]
	...
	for (let a of [
		...
		"all",
		"auto"
	]) t(`select-${a}`, [["-webkit-user-select", a], ["user-select", a]]);
	...
	]) l(a, ["--scroll-margin", "--spacing"], (w) => [o(g, w)], { supportsNegative: !0 });
	for (let [a, g] of [
	...
	for (let a of [
		...
		"right",
		"column"
	]) t(`break-before-${a}`, [["break-before", a]]);
	for (let a of [
		"auto",
		"avoid",
		"avoid-page",
		"avoid-column"
	]) t(`break-inside-${a}`, [["break-inside", a]]);
	for (let a of [
		"auto",
		"avoid",
		"all",
	...
	t("grid-flow-row", [["grid-auto-flow", "row"]]), t("grid-flow-col", [["grid-auto-flow", "column"]]), t("grid-flow-dense", [["grid-auto-flow", "dense"]]), t("grid-flow-row-dense", [["grid-auto-flow", "row dense"]]), t("grid-flow-col-dense", [["grid-auto-flow", "column dense"]]), n("auto-cols", {
		...
		handleBareValue: ({ value: a }) => !e.resolve(null, ["--spacing"]) || !de$1(a) ? null : `--spacing(${a})`,
		handle: (a) => [o("grid-auto-columns", a)],
		staticValues: {
		...
		handleBareValue: ({ value: a }) => ue$1(a) ? `repeat(${a}, minmax(0, 1fr))` : null,
		handle: (a) => [o("grid-template-columns", a)],
		staticValues: {
		...
		handleBareValue: ({ value: a }) => ue$1(a) ? `repeat(${a}, minmax(0, 1fr))` : null,
		handle: (a) => [o("grid-template-rows", a)],
		staticValues: {
		...
		handle: (a) => [H(":where(& > :not(:last-child))", [o("--tw-sort", "divide-color"), o("border-color", a)])]
	...
	for (let a of [
		...
		"visible",
		"scroll"
	]) t(`overflow-${a}`, [["overflow", a]]), t(`overflow-x-${a}`, [["overflow-x", a]]), t(`overflow-y-${a}`, [["overflow-y", a]]);
	for (let a of [
		"auto",
		"contain",
		"none"
	]) t(`overscroll-${a}`, [["overscroll-behavior", a]]), t(`overscroll-x-${a}`, [["overscroll-behavior-x", a]]), t(`overscroll-y-${a}`, [["overscroll-behavior-y", a]]);
	...
	{
		let a = () => Y([S("--tw-scrollbar-thumb", "#0000", "<color>"), S("--tw-scrollbar-track", "#0000", "<color>")]);
		s("scrollbar-thumb", {
			themeKeys: ["--color"],
			handle: (g) => [
				a(),
				o("--tw-scrollbar-thumb", g),
				o("scrollbar-color", "var(--tw-scrollbar-thumb) var(--tw-scrollbar-track)")
			]
		}), s("scrollbar-track", {
			themeKeys: ["--color"],
			handle: (g) => [
				a(),
				o("--tw-scrollbar-track", g),
				o("scrollbar-color", "var(--tw-scrollbar-thumb) var(--tw-scrollbar-track)")
			]
		});
	}
	...
	for (let [a, g] of [
		...
		themeKeys: ["--radius"],
		handle: (w) => g.map((C) => o(C, w)),
		staticValues: {
			none: g.map((w) => o(w, "0")),
			full: g.map((w) => o(w, "calc(infinity * 1px)"))
		}
	});
	t("border-solid", [["--tw-border-style", "solid"], ["border-style", "solid"]]), t("border-dashed", [["--tw-border-style", "dashed"], ["border-style", "dashed"]]), t("border-dotted", [["--tw-border-style", "dotted"], ["border-style", "dotted"]]), t("border-double", [["--tw-border-style", "double"], ["border-style", "double"]]), t("border-hidden", [["--tw-border-style", "hidden"], ["border-style", "hidden"]]), t("border-none", [["--tw-border-style", "none"], ["border-style", "none"]]);
	{
		let g = function(w, C) {
			i.functional(w, (x) => {
				if (!x.value) {
					if (x.modifier) return;
					let $ = e.get(["--default-border-width"]) ?? "1px", K = C.width($);
					return K ? [a(), ...K] : void 0;
				}
				if (x.value.kind === "arbitrary") {
					let $ = x.value.value;
					switch (x.value.dataType ?? ge($, [
						"color",
						"line-width",
						"length"
					])) {
						...
						default: return $ = te($, x.modifier, e), $ === null ? void 0 : C.color($);
					}
				}
				{
					let $ = oe(x, e, ["--border-color", "--color"]);
					if ($) return C.color($);
				}
				{
					if (x.modifier) return;
					let $ = e.resolve(x.value.value, ["--border-width"]);
					if ($) {
						let K = C.width($);
						return K ? [a(), ...K] : void 0;
					}
				...
				modifierThemeKeys: ["--opacity"],
				modifiers: Array.from({ length: 21 }, (x, $) => `${$ * 5}`),
				hasDefaultValue: !0
			}, {
				values: [
					"0",
		...
		let a = () => Y([S("--tw-border-style", "solid")]);
		g("border", {
			width: (w) => [o("border-style", "var(--tw-border-style)"), o("border-width", w)],
			color: (w) => [o("border-color", w)]
		}), g("border-x", {
			width: (w) => [o("border-inline-style", "var(--tw-border-style)"), o("border-inline-width", w)],
			color: (w) => [o("border-inline-color", w)]
		}), g("border-y", {
			width: (w) => [o("border-block-style", "var(--tw-border-style)"), o("border-block-width", w)],
			color: (w) => [o("border-block-color", w)]
		}), g("border-s", {
			width: (w) => [o("border-inline-start-style", "var(--tw-border-style)"), o("border-inline-start-width", w)],
			color: (w) => [o("border-inline-start-color", w)]
		}), g("border-e", {
			width: (w) => [o("border-inline-end-style", "var(--tw-border-style)"), o("border-inline-end-width", w)],
			color: (w) => [o("border-inline-end-color", w)]
		}), g("border-bs", {
			width: (w) => [o("border-block-start-style", "var(--tw-border-style)"), o("border-block-start-width", w)],
			color: (w) => [o("border-block-start-color", w)]
		}), g("border-be", {
			width: (w) => [o("border-block-end-style", "var(--tw-border-style)"), o("border-block-end-width", w)],
			color: (w) => [o("border-block-end-color", w)]
		}), g("border-t", {
			width: (w) => [o("border-top-style", "var(--tw-border-style)"), o("border-top-width", w)],
			color: (w) => [o("border-top-color", w)]
		}), g("border-r", {
			width: (w) => [o("border-right-style", "var(--tw-border-style)"), o("border-right-width", w)],
			color: (w) => [o("border-right-color", w)]
		}), g("border-b", {
			width: (w) => [o("border-bottom-style", "var(--tw-border-style)"), o("border-bottom-width", w)],
			color: (w) => [o("border-bottom-color", w)]
		}), g("border-l", {
			width: (w) => [o("border-left-style", "var(--tw-border-style)"), o("border-left-width", w)],
			color: (w) => [o("border-left-color", w)]
		}), n("divide-x", {
			defaultValue: e.get(["--default-border-width"]) ?? "1px",
			themeKeys: ["--divide-width", "--border-width"],
			handleBareValue: ({ value: w }) => u(w) ? `${w}px` : null,
			handle: (w) => [Y([S("--tw-divide-x-reverse", "0")]), H(":where(& > :not(:last-child))", [
				o("--tw-sort", "divide-x-width"),
				a(),
				o("--tw-divide-x-reverse", "0"),
				o("border-inline-style", "var(--tw-border-style)"),
				o("border-inline-start-width", `calc(${w} * var(--tw-divide-x-reverse))`),
				o("border-inline-end-width", `calc(${w} * calc(1 - var(--tw-divide-x-reverse)))`)
			])]
		}), n("divide-y", {
			defaultValue: e.get(["--default-border-width"]) ?? "1px",
			themeKeys: ["--divide-width", "--border-width"],
			handleBareValue: ({ value: w }) => u(w) ? `${w}px` : null,
			handle: (w) => [Y([S("--tw-divide-y-reverse", "0")]), H(":where(& > :not(:last-child))", [
				...
				o("border-top-width", `calc(${w} * var(--tw-divide-y-reverse))`),
				o("border-bottom-width", `calc(${w} * calc(1 - var(--tw-divide-y-reverse)))`)
			])]
		}), r("divide-x", () => [{
			values: [
				"0",
			...
			valueThemeKeys: ["--divide-width", "--border-width"],
			hasDefaultValue: !0
		}]), t("divide-x-reverse", [() => Y([S("--tw-divide-x-reverse", "0")]), () => H(":where(& > :not(:last-child))", [o("--tw-divide-x-reverse", "1")])]), t("divide-y-reverse", [() => Y([S("--tw-divide-y-reverse", "0")]), () => H(":where(& > :not(:last-child))", [o("--tw-divide-y-reverse", "1")])]);
		for (let w of [
			"solid",
			"dashed",
			"dotted",
	...
	} }), t("bg-repeat", [["background-repeat", "repeat"]]), t("bg-no-repeat", [["background-repeat", "no-repeat"]]), t("bg-repeat-x", [["background-repeat", "repeat-x"]]), t("bg-repeat-y", [["background-repeat", "repeat-y"]]), t("bg-repeat-round", [["background-repeat", "round"]]), t("bg-repeat-space", [["background-repeat", "space"]]), t("bg-none", [["background-image", "none"]]);
	{
		let w = function($) {
			...
			if ($?.kind === "named") switch ($.value) {
				...
				case "increasing":
				case "decreasing":
					K = `in oklch ${$.value} hue`;
					break;
				default: K = `in ${$.value}`;
			}
			else $?.kind === "arbitrary" && (K = $.value);
			return K;
		}, C = function({ negative: $ }) {
			return (K) => {
				if (!K.value) return;
				if (K.value.kind === "arbitrary") {
					...
					let W = K.value.value;
					return (K.value.dataType ?? ge(W, ["angle"])) === "angle" ? (W = $ ? `calc(${W} * -1)` : `${W}`, [o("--tw-gradient-position", W), o("background-image", `linear-gradient(var(--tw-gradient-stops,${W}))`)]) : $ ? void 0 : [o("--tw-gradient-position", W), o("background-image", `linear-gradient(var(--tw-gradient-stops,${W}))`)];
				}
				let T = K.value.value;
				if (!$ && g.has(T)) T = g.get(T);
				else if (u(T)) T = $ ? `calc(${T}deg * -1)` : `${T}deg`;
				else return;
				let R = w(K.modifier);
				return [
					o("--tw-gradient-position", `${T}`),
					J("@supports (background-image: linear-gradient(in lab, red, red))", [o("--tw-gradient-position", `${T} ${R}`)]),
			...
			return (K) => {
				if (K.value?.kind === "arbitrary") {
					if (K.modifier) return;
					let W = K.value.value;
					return [o("--tw-gradient-position", W), o("background-image", `conic-gradient(var(--tw-gradient-stops,${W}))`)];
				}
				let T = w(K.modifier);
				if (!K.value) return [o("--tw-gradient-position", T), o("background-image", "conic-gradient(var(--tw-gradient-stops))")];
				let R = K.value.value;
				if (u(R)) return R = $ ? `calc(${R}deg * -1)` : `${R}deg`, [o("--tw-gradient-position", `from ${R} ${T}`), o("background-image", "conic-gradient(var(--tw-gradient-stops))")];
			};
		};
		let a = [
			"oklab",
		...
		i.functional("-bg-linear", C({ negative: !0 })), i.functional("bg-linear", C({ negative: !1 })), r("bg-linear", () => [{
			...
			supportsNegative: !0,
			modifiers: a
		}]), i.functional("-bg-conic", x({ negative: !0 })), i.functional("bg-conic", x({ negative: !1 })), r("bg-conic", () => [{
			hasDefaultValue: !0,
			modifiers: a
		}, {
			values: [
			...
			supportsNegative: !0,
			modifiers: a
		}]), i.functional("bg-radial", ($) => {
			if (!$.value) return [o("--tw-gradient-position", w($.modifier)), o("background-image", "radial-gradient(var(--tw-gradient-stops))")];
			if ($.value.kind === "arbitrary") {
				if ($.modifier) return;
				let K = $.value.value;
				return [o("--tw-gradient-position", K), o("background-image", `radial-gradient(var(--tw-gradient-stops,${K}))`)];
			}
		}), r("bg-radial", () => [{
			hasDefaultValue: !0,
			modifiers: a
	...
	i.functional("bg", (a) => {
		if (a.value) {
			if (a.value.kind === "arbitrary") {
				...
				switch (a.value.dataType ?? ge(g, [
					...
					case "percentage":
					case "position": return a.modifier ? void 0 : [o("background-position", g)];
					case "bg-size":
					case "length":
					case "size": return a.modifier ? void 0 : [o("background-size", g)];
					case "image":
					case "url": return a.modifier ? void 0 : [o("background-image", g)];
					default: return g = te(g, a.modifier, e), g === null ? void 0 : [o("background-color", g)];
				}
			}
			{
				let g = oe(a, e, ["--background-color", "--color"]);
				if (g) return [o("background-color", g)];
			}
			{
				if (a.modifier) return;
				let g = e.resolve(a.value.value, ["--background-image"]);
		...
		modifierThemeKeys: ["--opacity"],
		modifiers: Array.from({ length: 21 }, (a, g) => `${g * 5}`)
	}, {
		values: [],
	...
	function y$1(a, g) {
		i.functional(a, (w) => {
			if (w.value) {
				...
				{
					let C = oe(w, e, ["--background-color", "--color"]);
	...
	y$1("from", {
		...
		position: (a) => [v(), o("--tw-gradient-from-position", a)]
	}), t("via-none", [["--tw-gradient-via-stops", "initial"]]), y$1("via", {
		color: (a) => [
			v(),
		...
		position: (a) => [v(), o("--tw-gradient-via-position", a)]
	}), y$1("to", {
		color: (a) => [
			v(),
		...
		position: (a) => [v(), o("--tw-gradient-to-position", a)]
	}), t("mask-none", [["mask-image", "none"]]), i.functional("mask", (a) => {
		...
		switch (a.value.dataType ?? ge(g, [
			...
			case "percentage":
			case "position": return a.modifier ? void 0 : [o("mask-position", g)];
			case "bg-size":
			case "length":
		...
		N(a, {
			color(C) {
				...
				for (let $ of [
					...
					"bottom",
					"left"
				]) w[$] && (x.push(o(`--tw-mask-${$}`, `linear-gradient(to ${$}, var(--tw-mask-${$}-from-color) var(--tw-mask-${$}-from-position), var(--tw-mask-${$}-to-color) var(--tw-mask-${$}-to-position))`)), x.push(Y([
					S(`--tw-mask-${$}-from-position`, "0%"),
					S(`--tw-mask-${$}-to-position`, "100%"),
					S(`--tw-mask-${$}-from-color`, "black"),
					S(`--tw-mask-${$}-to-color`, "transparent")
				])), x.push(o(`--tw-mask-${$}-${g}-color`, C)));
				return x;
			},
			position(C) {
				let x = [
	...
	n("mask-linear", {
		...
		handleBareValue({ value: a }) {
			if (!u(a)) return null;
			let g = Number(a);
			return g === 0 ? "0deg" : g === 1 ? "1deg" : `calc(1deg * ${a})`;
		},
	...
	t("mask-circle", [["--tw-mask-radial-shape", "circle"]]), t("mask-ellipse", [["--tw-mask-radial-shape", "ellipse"]]), t("mask-radial-closest-side", [["--tw-mask-radial-size", "closest-side"]]), t("mask-radial-farthest-side", [["--tw-mask-radial-size", "farthest-side"]]), t("mask-radial-closest-corner", [["--tw-mask-radial-size", "closest-corner"]]), t("mask-radial-farthest-corner", [["--tw-mask-radial-size", "farthest-corner"]]), t("mask-radial-at-top", [["--tw-mask-radial-position", "top"]]), t("mask-radial-at-top-left", [["--tw-mask-radial-position", "top left"]]), t("mask-radial-at-top-right", [["--tw-mask-radial-position", "top right"]]), t("mask-radial-at-bottom", [["--tw-mask-radial-position", "bottom"]]), t("mask-radial-at-bottom-left", [["--tw-mask-radial-position", "bottom left"]]), t("mask-radial-at-bottom-right", [["--tw-mask-radial-position", "bottom right"]]), t("mask-radial-at-left", [["--tw-mask-radial-position", "left"]]), t("mask-radial-at-right", [["--tw-mask-radial-position", "right"]]), t("mask-radial-at-center", [["--tw-mask-radial-position", "center"]]), n("mask-radial-at", {
		...
		supportsNegative: !1,
		supportsFractions: !1,
		handle: (a) => [o("--tw-mask-radial-position", a)]
	}), n("mask-radial", {
		defaultValue: null,
		supportsNegative: !1,
		supportsFractions: !1,
	...
	for (let a of [
		...
		"color",
		"luminosity"
	]) t(`bg-blend-${a}`, [["background-blend-mode", a]]), t(`mix-blend-${a}`, [["mix-blend-mode", a]]);
	t("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]), t("mix-blend-plus-lighter", [["mix-blend-mode", "plus-lighter"]]), t("fill-none", [["fill", "none"]]), i.functional("fill", (a) => {
		if (!a.value) return;
		if (a.value.kind === "arbitrary") {
			let w = te(a.value.value, a.modifier, e);
			return w === null ? void 0 : [o("fill", w)];
		}
		let g = oe(a, e, ["--fill", "--color"]);
		...
		modifierThemeKeys: ["--opacity"],
		modifiers: Array.from({ length: 21 }, (a, g) => `${g * 5}`)
	}]), t("stroke-none", [["stroke", "none"]]), i.functional("stroke", (a) => {
		if (a.value) {
			if (a.value.kind === "arbitrary") {
				let g = a.value.value;
				switch (a.value.dataType ?? ge(g, [
					...
					case "number":
					case "length":
					case "percentage": return a.modifier ? void 0 : [o("stroke-width", g)];
					default: return g = te(a.value.value, a.modifier, e), g === null ? void 0 : [o("stroke", g)];
				}
			}
			{
				let g = oe(a, e, ["--stroke", "--color"]);
				if (g) return [o("stroke", g)];
			}
			{
				let g = e.resolve(a.value.value, ["--stroke-width"]);
	...
	for (let [a, g] of [
		...
		["pb", "padding-bottom"],
		["pl", "padding-left"]
	]) l(a, ["--padding", "--spacing"], (w) => [o(g, w)]);
	t("text-left", [["text-align", "left"]]), t("text-center", [["text-align", "center"]]), t("text-right", [["text-align", "right"]]), t("text-justify", [["text-align", "justify"]]), t("text-start", [["text-align", "start"]]), t("text-end", [["text-align", "end"]]), l("indent", ["--text-indent", "--spacing"], (a) => [o("text-indent", a)], { supportsNegative: !0 }), t("align-baseline", [["vertical-align", "baseline"]]), t("align-top", [["vertical-align", "top"]]), t("align-middle", [["vertical-align", "middle"]]), t("align-bottom", [["vertical-align", "bottom"]]), t("align-text-top", [["vertical-align", "text-top"]]), t("align-text-bottom", [["vertical-align", "text-bottom"]]), t("align-sub", [["vertical-align", "sub"]]), t("align-super", [["vertical-align", "super"]]), n("align", {
		themeKeys: [],
		handle: (a) => [o("vertical-align", a)]
	}), i.functional("font", (a) => {
		if (!(!a.value || a.modifier)) {
			...
			{
				let g = e.resolveWith(a.value.value, ["--font"], ["--font-feature-settings", "--font-variation-settings"]);
				if (g) {
					let [w, C = {}] = g;
					return [
						o("font-family", w),
			...
			{
				let g = e.resolve(a.value.value, ["--font-weight"]);
				if (g) return [
					Y([S("--tw-font-weight")]),
					o("--tw-font-weight", g),
					o("font-weight", g)
		...
		themeKeys: [],
		handle: (a) => [o("font-feature-settings", a)]
		...
		handleBareValue: ({ value: a }) => {
			...
			let g = Number(a.slice(0, -1));
			return !u(g) || Number.isNaN(g) || g < 50 || g > 200 ? null : a;
		},
		handle: (a) => [o("font-stretch", a)]
		...
		if (a.value) {
			if (a.value.kind === "arbitrary") {
				...
				switch (a.value.dataType ?? ge(g, [
					...
					case "length":
					case "percentage": return a.modifier ? void 0 : [o("text-decoration-thickness", g)];
					default: return g = te(g, a.modifier, e), g === null ? void 0 : [o("text-decoration-color", g)];
				}
			}
			{
				let g = e.resolve(a.value.value, ["--text-decoration-thickness"]);
				if (g) return a.modifier ? void 0 : [o("text-decoration-thickness", g)];
				if (u(a.value.value)) return a.modifier ? void 0 : [o("text-decoration-thickness", `${a.value.value}px`)];
			}
			{
				let g = oe(a, e, ["--text-decoration-color", "--color"]);
	...
	});
	{
		...
		i.functional("filter", (x) => {
			if (!x.modifier) {
				if (x.value === null) return [w(), o("filter", a)];
				if (x.value.kind === "arbitrary") return [o("filter", x.value.value)];
				if (x.value.value === "none") return [o("filter", "none")];
			}
		}), i.functional("backdrop-filter", (x) => {
			if (!x.modifier) {
				...
				if (x.value.kind === "arbitrary") return [o("-webkit-backdrop-filter", x.value.value), o("backdrop-filter", x.value.value)];
				if (x.value.value === "none") return [o("-webkit-backdrop-filter", "none"), o("backdrop-filter", "none")];
			}
		}), n("blur", {
			themeKeys: ["--blur"],
			handle: (x) => [
			...
			handle: (x) => [
				C(),
				o("--tw-backdrop-brightness", `brightness(${x})`),
				o("-webkit-backdrop-filter", g),
				o("backdrop-filter", g)
			]
		}), r("brightness", () => [{
			...
			handle: (x) => [
				C(),
				o("--tw-backdrop-contrast", `contrast(${x})`),
				o("-webkit-backdrop-filter", g),
				o("backdrop-filter", g)
			]
		}), r("contrast", () => [{
			...
			handle: (x) => [
				C(),
				o("--tw-backdrop-grayscale", `grayscale(${x})`),
				o("-webkit-backdrop-filter", g),
				o("backdrop-filter", g)
			]
		}), r("grayscale", () => [{
			...
			handle: (x) => [
				C(),
				o("--tw-backdrop-hue-rotate", `hue-rotate(${x})`),
				o("-webkit-backdrop-filter", g),
				o("backdrop-filter", g)
			]
		}), r("hue-rotate", () => [{
			...
			handle: (x) => [
				C(),
				o("--tw-backdrop-saturate", `saturate(${x})`),
				o("-webkit-backdrop-filter", g),
				o("backdrop-filter", g)
			]
		}), r("saturate", () => [{
			...
			["--tw-drop-shadow", " "],
			["filter", a]
		]), i.functional("drop-shadow", (x) => {
			let $;
			if (x.modifier && (x.modifier.kind === "arbitrary" ? $ = x.modifier.value : u(x.modifier.value) && ($ = `${x.modifier.value}%`)), !x.value) {
				let K = e.get(["--drop-shadow"]), T = e.resolve(null, ["--drop-shadow"]);
				return K === null || T === null ? void 0 : [
					w(),
					o("--tw-drop-shadow-alpha", $),
					...gt("--tw-drop-shadow-size", K, $, (R) => `var(--tw-drop-shadow-color, ${R})`),
					o("--tw-drop-shadow", d(T, ",").map((R) => `drop-shadow(${R})`).join(" ")),
					o("filter", a)
				];
			}
			if (x.value.kind === "arbitrary") {
				let K = x.value.value;
				return (x.value.dataType ?? ge(K, ["color"])) === "color" ? (K = te(K, x.modifier, e), K === null ? void 0 : [
					w(),
					o("--tw-drop-shadow-color", X(K, "var(--tw-drop-shadow-alpha)")),
			...
			{
				let K = e.get([`--drop-shadow-${x.value.value}`]), T = e.resolve(x.value.value, ["--drop-shadow"]);
				if (K && T) return x.modifier && !$ ? void 0 : $ ? [
					w(),
					o("--tw-drop-shadow-alpha", $),
					...gt("--tw-drop-shadow-size", K, $, (R) => `var(--tw-drop-shadow-color, ${R})`),
					o("--tw-drop-shadow", "var(--tw-drop-shadow-size)"),
			...
			{
				let K = oe(x, e, ["--drop-shadow-color", "--color"]);
			...
			handleBareValue: ({ value: x }) => xe$1(x) ? `${x}%` : null,
			handle: (x) => [
				C(),
				o("--tw-backdrop-opacity", `opacity(${x})`),
				o("-webkit-backdrop-filter", g),
				o("backdrop-filter", g)
			]
		}), r("backdrop-opacity", () => [{
			values: Array.from({ length: 21 }, (x, $) => `${$ * 5}`),
			valueThemeKeys: ["--backdrop-opacity", "--opacity"]
		}]);
	}
	{
		let a = `var(--tw-ease, ${e.resolve(null, ["--default-transition-timing-function"]) ?? "ease"})`, g = `var(--tw-duration, ${e.resolve(null, ["--default-transition-duration"]) ?? "0s"})`;
		n("transition", {
			...
			handle: (w) => [o("transition-delay", w)]
		});
		{
			let w = () => Y([S("--tw-duration")]);
			t("duration-initial", [w, ["--tw-duration", "initial"]]), i.functional("duration", (C) => {
				if (C.modifier || !C.value) return;
				let x = null;
				if (C.value.kind === "arbitrary" ? x = C.value.value : (x = e.resolve(C.value.fraction ?? C.value.value, ["--transition-duration"]), x === null && u(C.value.value) && (x = `${C.value.value}ms`)), x !== null) return [
					w(),
					o("--tw-duration", x),
	...
	{
		let a = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)", g = () => Y([
			S("--tw-contain-size"),
			S("--tw-contain-layout"),
			S("--tw-contain-paint"),
			S("--tw-contain-style")
		...
		t("contain-none", [["contain", "none"]]), t("contain-content", [["contain", "content"]]), t("contain-strict", [["contain", "strict"]]), t("contain-size", [
			...
			themeKeys: [],
			handle: (w) => [o("contain", w)]
		});
	}
	t("forced-color-adjust-none", [["forced-color-adjust", "none"]]), t("forced-color-adjust-auto", [["forced-color-adjust", "auto"]]), l("leading", ["--leading", "--spacing"], (a) => [
		Y([S("--tw-leading")]),
		o("--tw-leading", a),
		o("line-height", a)
	], { staticValues: { none: [
	...
	{
		let a = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)", g = () => Y([
			S("--tw-ordinal"),
			S("--tw-slashed-zero"),
			S("--tw-numeric-figure"),
	...
	{
		let a = () => Y([S("--tw-outline-style", "solid")]);
		i.static("outline-hidden", () => [
			o("--tw-outline-style", "none"),
			o("outline-style", "none"),
			B("@media", "(forced-colors: active)", [o("outline", "2px solid transparent"), o("outline-offset", "2px")])
			...
			if (g.value.kind === "arbitrary") {
				...
				switch (g.value.dataType ?? ge(w, [
					...
					default: return w = te(w, g.modifier, e), w === null ? void 0 : [o("outline-color", w)];
				}
			}
			{
				let w = oe(g, e, ["--outline-color", "--color"]);
				if (w) return [o("outline-color", w)];
			}
			{
				if (g.modifier) return;
	...
	n("opacity", {
		...
		handle: (a) => [o("opacity", a)]
	}), r("opacity", () => [{
		values: Array.from({ length: 21 }, (a, g) => `${g * 5}`),
		valueThemeKeys: ["--opacity"]
	}]), n("underline-offset", {
		supportsNegative: !0,
		themeKeys: ["--text-underline-offset"],
		handleBareValue: ({ value: a }) => u(a) ? `${a}px` : null,
		handle: (a) => [o("text-underline-offset", a)],
		...
		if (a.value) {
			if (a.value.kind === "arbitrary") {
				...
				switch (a.value.dataType ?? ge(g, [
					...
					case "relative-size":
						if (a.modifier) {
							let C = a.modifier.kind === "arbitrary" ? a.modifier.value : e.resolve(a.modifier.value, ["--leading"]);
							if (!C && de$1(a.modifier.value)) {
								if (!e.resolve(null, ["--spacing"])) return null;
								C = `--spacing(${a.modifier.value})`;
							}
							return !C && a.modifier.value === "none" && (C = "1"), C ? [o("font-size", g), o("line-height", C)] : null;
						}
						return [o("font-size", g)];
					default: return g = te(g, a.modifier, e), g === null ? void 0 : [o("color", g)];
				}
			}
			{
				let g = oe(a, e, ["--text-color", "--color"]);
				if (g) return [o("color", g)];
			}
			{
				let g = e.resolveWith(a.value.value, ["--text"], [
					"--line-height",
					"--letter-spacing",
					"--font-weight"
				]);
				if (g) {
					...
					if (a.modifier) {
						let x = a.modifier.kind === "arbitrary" ? a.modifier.value : e.resolve(a.modifier.value, ["--leading"]);
						if (!x && de$1(a.modifier.value)) {
							if (!e.resolve(null, ["--spacing"])) return null;
							x = `--spacing(${a.modifier.value})`;
						}
						if (!x && a.modifier.value === "none" && (x = "1"), !x) return null;
						let $ = [o("font-size", w)];
						return x && $.push(o("line-height", x)), $;
					}
					return typeof C == "string" ? [o("font-size", w), o("line-height", C)] : [
						o("font-size", w),
	...
	let z = () => Y([S("--tw-text-shadow-color"), S("--tw-text-shadow-alpha", "100%", "<percentage>")]);
	t("text-shadow-initial", [z, ["--tw-text-shadow-color", "initial"]]), i.functional("text-shadow", (a) => {
		let g;
		if (a.modifier && (a.modifier.kind === "arbitrary" ? g = a.modifier.value : u(a.modifier.value) && (g = `${a.modifier.value}%`)), !a.value) {
			let w = e.get(["--text-shadow"]);
			return w === null ? void 0 : [
				z(),
				o("--tw-text-shadow-alpha", g),
				...ke("text-shadow", w, g, (C) => `var(--tw-text-shadow-color, ${C})`)
			];
		}
		if (a.value.kind === "arbitrary") {
			let w = a.value.value;
			return (a.value.dataType ?? ge(w, ["color"])) === "color" ? (w = te(w, a.modifier, e), w === null ? void 0 : [z(), o("--tw-text-shadow-color", X(w, "var(--tw-text-shadow-alpha)"))]) : [
				z(),
				o("--tw-text-shadow-alpha", g),
				...ke("text-shadow", w, g, (x) => `var(--tw-text-shadow-color, ${x})`)
			];
		}
		switch (a.value.value) {
			case "none": return a.modifier ? void 0 : [z(), o("text-shadow", "none")];
			case "inherit": return a.modifier ? void 0 : [z(), o("--tw-text-shadow-color", "inherit")];
		}
		{
			let w = e.get([`--text-shadow-${a.value.value}`]);
			if (w) return [
				z(),
				o("--tw-text-shadow-alpha", g),
				...ke("text-shadow", w, g, (C) => `var(--tw-text-shadow-color, ${C})`)
		...
		{
			let w = oe(a, e, ["--text-shadow-color", "--color"]);
			if (w) return [z(), o("--tw-text-shadow-color", X(w, "var(--tw-text-shadow-alpha)"))];
		}
	}), r("text-shadow", () => [
		{
			values: [
	...
	]);
	{
		...
		t("shadow-initial", [w, ["--tw-shadow-color", "initial"]]), i.functional("shadow", (T) => {
			let R;
			if (T.modifier && (T.modifier.kind === "arbitrary" ? R = T.modifier.value : u(T.modifier.value) && (R = `${T.modifier.value}%`)), !T.value) {
				let W = e.get(["--shadow"]);
				return W === null ? void 0 : [
					w(),
					o("--tw-shadow-alpha", R),
					...ke("--tw-shadow", W, R, (ge) => `var(--tw-shadow-color, ${ge})`),
					o("box-shadow", a)
				];
			}
			if (T.value.kind === "arbitrary") {
				let W = T.value.value;
				return (T.value.dataType ?? ge(W, ["color"])) === "color" ? (W = te(W, T.modifier, e), W === null ? void 0 : [w(), o("--tw-shadow-color", X(W, "var(--tw-shadow-alpha)"))]) : [
					w(),
					o("--tw-shadow-alpha", R),
					...ke("--tw-shadow", W, R, (Et) => `var(--tw-shadow-color, ${Et})`),
					o("box-shadow", a)
				];
			}
			switch (T.value.value) {
				case "none": return T.modifier ? void 0 : [
					w(),
					o("--tw-shadow", g),
					o("box-shadow", a)
				];
				case "inherit": return T.modifier ? void 0 : [w(), o("--tw-shadow-color", "inherit")];
			}
			{
				let W = e.get([`--shadow-${T.value.value}`]);
				if (W) return [
					w(),
					o("--tw-shadow-alpha", R),
					...ke("--tw-shadow", W, R, (ge) => `var(--tw-shadow-color, ${ge})`),
			...
			{
				let W = oe(T, e, ["--box-shadow-color", "--color"]);
				if (W) return [w(), o("--tw-shadow-color", X(W, "var(--tw-shadow-alpha)"))];
			}
		}), r("shadow", () => [
			{
				values: [
				...
				modifierThemeKeys: ["--opacity"],
				modifiers: Array.from({ length: 21 }, (T, R) => `${R * 5}`)
			},
			{ values: ["none"] },
			{
		...
		]), t("inset-shadow-initial", [w, ["--tw-inset-shadow-color", "initial"]]), i.functional("inset-shadow", (T) => {
			let R;
			if (T.modifier && (T.modifier.kind === "arbitrary" ? R = T.modifier.value : u(T.modifier.value) && (R = `${T.modifier.value}%`)), !T.value) {
				...
				return W === null ? void 0 : [
					...
					...ke("--tw-inset-shadow", W, R, (ge) => `var(--tw-inset-shadow-color, ${ge})`),
					o("box-shadow", a)
				];
			}
			if (T.value.kind === "arbitrary") {
				let W = T.value.value;
				return (T.value.dataType ?? ge(W, ["color"])) === "color" ? (W = te(W, T.modifier, e), W === null ? void 0 : [w(), o("--tw-inset-shadow-color", X(W, "var(--tw-inset-shadow-alpha)"))]) : [
					w(),
					o("--tw-inset-shadow-alpha", R),
					...ke("--tw-inset-shadow", W, R, (Et) => `var(--tw-inset-shadow-color, ${Et})`, "inset"),
					o("box-shadow", a)
				];
			}
			switch (T.value.value) {
				case "none": return T.modifier ? void 0 : [
					w(),
					o("--tw-inset-shadow", `inset ${g}`),
					o("box-shadow", a)
				];
				case "inherit": return T.modifier ? void 0 : [w(), o("--tw-inset-shadow-color", "inherit")];
			}
			{
				let W = e.get([`--inset-shadow-${T.value.value}`]);
				if (W) return [
					w(),
					o("--tw-inset-shadow-alpha", R),
					...ke("--tw-inset-shadow", W, R, (ge) => `var(--tw-inset-shadow-color, ${ge})`),
			...
			{
				let W = oe(T, e, ["--box-shadow-color", "--color"]);
				if (W) return [w(), o("--tw-inset-shadow-color", X(W, "var(--tw-inset-shadow-alpha)"))];
			}
		}), r("inset-shadow", () => [
			{
				values: [
		...
		i.functional("ring", (T) => {
			if (!T.value) {
				...
				return [
					w(),
					o("--tw-ring-shadow", x(R)),
					o("box-shadow", a)
				];
			}
			if (T.value.kind === "arbitrary") {
				let R = T.value.value;
				return (T.value.dataType ?? ge(R, ["color", "length"])) === "length" ? T.modifier ? void 0 : [
					w(),
					o("--tw-ring-shadow", x(R)),
					o("box-shadow", a)
				] : (R = te(R, T.modifier, e), R === null ? void 0 : [o("--tw-ring-color", R)]);
			}
			{
				let R = oe(T, e, ["--ring-color", "--color"]);
				if (R) return [o("--tw-ring-color", R)];
			}
			{
				if (T.modifier) return;
				let R = e.resolve(T.value.value, ["--ring-width"]);
				if (R === null && u(T.value.value) && (R = `${T.value.value}px`), R) return [
					w(),
					o("--tw-ring-shadow", x(R)),
					o("box-shadow", a)
				];
			...
			hasDefaultValue: !0
		}]), i.functional("inset-ring", (T) => {
			if (!T.value) return T.modifier ? void 0 : [
				w(),
				o("--tw-inset-ring-shadow", $("1px")),
				o("box-shadow", a)
			];
			if (T.value.kind === "arbitrary") {
				let R = T.value.value;
				return (T.value.dataType ?? ge(R, ["color", "length"])) === "length" ? T.modifier ? void 0 : [
					w(),
					o("--tw-inset-ring-shadow", $(R)),
					o("box-shadow", a)
				] : (R = te(R, T.modifier, e), R === null ? void 0 : [o("--tw-inset-ring-color", R)]);
			}
			{
				let R = oe(T, e, ["--ring-color", "--color"]);
		...
		i.functional("ring-offset", (T) => {
			if (T.value) {
				if (T.value.kind === "arbitrary") {
					let R = T.value.value;
					return (T.value.dataType ?? ge(R, ["color", "length"])) === "length" ? T.modifier ? void 0 : [o("--tw-ring-offset-width", R), o("--tw-ring-offset-shadow", K)] : (R = te(R, T.modifier, e), R === null ? void 0 : [o("--tw-ring-offset-color", R)]);
				}
				{
					let R = e.resolve(T.value.value, ["--ring-offset-width"]);
					if (R) return T.modifier ? void 0 : [o("--tw-ring-offset-width", R), o("--tw-ring-offset-shadow", K)];
					if (u(T.value.value)) return T.modifier ? void 0 : [o("--tw-ring-offset-width", `${T.value.value}px`), o("--tw-ring-offset-shadow", K)];
				}
				{
					let R = oe(T, e, ["--ring-offset-color", "--color"]);
	...
	}]), i.functional("@container", (a) => {
		let g = null;
		if (a.value === null ? g = "inline-size" : a.value.kind === "arbitrary" ? g = a.value.value : a.value.kind === "named" && a.value.value === "normal" ? g = "normal" : a.value.kind === "named" && a.value.value === "size" && (g = "size"), g !== null) return a.modifier ? [o("container-type", g), o("container-name", a.modifier.value)] : [o("container-type", g)];
	}), r("@container", () => [{
		values: ["normal"],
		valueThemeKeys: [],
		hasDefaultValue: !0
	...
	return Ln(i) ? (r) => {
		...
		_(e.nodes, (n) => {
			...
			_(s, (l) => {
				...
				if (l.value === "--spacing" && !(t["--modifier"].usedSpacingNumber && t["--value"].usedSpacingNumber)) return _(l.nodes, (f) => {
					if (f.kind !== "function" || f.value !== "--value" && f.value !== "--modifier") return;
					let c = f.value;
					for (let m of f.nodes) if (m.kind === "word") {
				...
				let p = d(F(l.nodes), ",");
				for (let [f, c] of p.entries()) c = c.replace(/\\\*/g, "*"), c = c.replace(/--(.*?)\s--(.*?)/g, "--$1-*--$2"), c = c.replace(/\s+/g, ""), c = c.replace(/(-\*){2,}/g, "-*"), c[0] === "-" && c[1] === "-" && !c.includes("(") && !c.includes("-*") && (c += "-*"), p[f] = c;
				l.nodes = M(p.join(","));
				...
				} else if (f.kind === "word" && !(f.value[0] === "[" && f.value[f.value.length - 1] === "]") && !Yt.includes(f.value)) {
					console.warn(`Unsupported bare value data type: "${f.value}".
Only valid data types are: ${Yt.map((y) => `"${y}"`).join(", ")}.
`);
					let c = f.value, m = structuredClone(l), d = "¶";
					_(m.nodes, (y) => {
						if (y.kind === "word" && y.value === c) return V.ReplaceSkip({
							kind: "word",
							value: d
						});
					});
					let u = "^".repeat(F([f]).length), h = F([m]).indexOf(d), v = [
						"```css",
						F([l]),
						" ".repeat(h) + u,
						"```"
...
`);
			...
			let s = re(e), l = n.value, p = n.modifier, f = !1, c = !1, m = !1, d = !1, u = /* @__PURE__ */ new Map(), h = !1;
			if (_([s], (v, y) => {
				let b = y.parent;
				if (b?.kind !== "rule" && b?.kind !== "at-rule" || v.kind !== "declaration" || !v.value) return;
				let N = !1, A = M(v.value);
				if (_(A, (k) => {
					if (k.kind === "function") {
						if (k.value === "--value") {
							f = !0;
							let D = Lr(l, k, r);
							return D ? (c = !0, D.ratio ? h = !0 : u.set(v, b), V.ReplaceSkip(D.nodes)) : (N = !0, V.Stop);
						} else if (k.value === "--modifier") {
							m = !0;
							let D = Lr(p, k, r);
							return D ? (d = !0, V.ReplaceSkip(D.nodes)) : (N = !0, V.Stop);
						}
					}
				}), N) return V.ReplaceSkip([]);
				v.value = F(A);
			}), !f || !c || m && !d && p !== null || h && d || p && !h && !d) return null;
			if (h) for (let [v, y] of u) {
				let b = y.nodes.indexOf(v);
				b !== -1 && y.nodes.splice(b, 1);
			}
			return s.nodes;
		}), r.utilities.suggest(i.slice(0, -2), () => {
			let n = [], s = [];
			for (let [l, { literals: p, usedSpacingNumber: f, usedSpacingInteger: c, themeKeys: m }] of [[n, t["--value"]], [s, t["--modifier"]]]) {
				for (let d of p) l.push(d);
				if (f) l.push(...wt);
				else if (c) for (let d of wt) u(d) && l.push(d);
				for (let d of r.theme.keysInNamespaces(m)) l.push(d.replace(Mr, (u, h, v) => `${h}.${v}`));
			}
			return [{
				values: n,
				modifiers: s
	...
	for (let t of i.nodes) {
		...
		if (e.kind === "named" && t.kind === "word" && t.value[0] === "-" && t.value[1] === "-") {
			...
			if (n.endsWith("-*")) {
				...
				let l = [s.shift()], p = r.theme.resolveWith(e.value, l, s);
				if (p) {
					let [, f = {}] = p;
					{
						let c = f[s.pop()];
			...
			if (ge(e.value, [n]) !== null) return { nodes: M(e.value) };
		}
	}
}
function ke(e, i, r, t, n = "") {
	let s = !1, l = et(i, (f) => r == null ? t(f) : f.startsWith("current") ? t(X(f, r)) : ((f.startsWith("var(") || r.startsWith("var(")) && (s = !0), t(jr(f, r))));
	function p(f) {
		return n ? d(f, ",").map((c) => n.trim() + " " + c.trim()).join(", ") : f;
	}
	return s ? [o(e, p(et(i, t))), J("@supports (color: lab(from red l a b))", [o(e, p(l))])] : [o(e, p(l))];
}
function gt(e, i, r, t, n = "") {
	let s = !1, l = d(i, ",").map((p) => et(p, (f) => r == null ? t(f) : f.startsWith("current") ? t(X(f, r)) : ((f.startsWith("var(") || r.startsWith("var(")) && (s = !0), t(jr(f, r))))).map((p) => `drop-shadow(${p})`).join(" ");
	return s ? [o(e, n + d(i, ",").map((p) => `drop-shadow(${et(p, t)})`).join(" ")), J("@supports (color: lab(from red l a b))", [o(e, n + l)])] : [o(e, n + l)];
}
var Br = /^-?[a-z][a-zA-Z0-9_-]*/, En = 37, Rn = 47, Pn = 46, On = 97, _n = 122, In = 65, Dn = 90, ht = 48, vt = 57, Kn = 95, Un = 45;
function zn(e) {
	let i = Br.exec(e);
	if (i === null) return !1;
	...
	for (let s = 0; s < t.length; s++) {
		...
		switch (l) {
			...
			case Pn: {
				...
				if (m < ht || m > vt) return !1;
				break;
			}
			case Kn:
			case Un: continue;
			default:
				if (l >= On && l <= _n || l >= In && l <= Dn || l >= ht && l <= vt) continue;
				return !1;
		}
	}
	return !0;
...
var Yr = new RegExp(Object.keys(Gt).map((e) => `${e}\\(`).join("|"));
function Ue(e, i) {
	let r = 0;
	return _(e, (t) => {
...
function Gr(e, i, r) {
	...
	return _(t, (n) => {
		if (n.kind === "function" && n.value in Gt) {
			let s = d(F(n.nodes).trim(), ",").map((p) => p.trim()), l = Gt[n.value](r, i, ...s);
...
function yt(e, i) {
	...
	for (let s = 0; s < n; s++) {
		let l = e.charCodeAt(s), p = i.charCodeAt(s);
		if (l >= 48 && l <= 57 && p >= 48 && p <= 57) {
			let f = s, c = s + 1, m = s, d = s + 1;
			for (l = e.charCodeAt(c); l >= 48 && l <= 57;) l = e.charCodeAt(++c);
			for (p = i.charCodeAt(d); p >= 48 && p <= 57;) p = i.charCodeAt(++d);
			let u = e.slice(f, c), h = i.slice(m, d), v = Number(u) - Number(h);
			if (v) return v;
			if (u < h) return -1;
			if (u > h) return 1;
			continue;
...
function qr(e) {
	...
	if (l = e.charCodeAt(i), l === 39 || l === 34) {
		...
		for (r = i; i < t && !Le(e.charCodeAt(i));) i++;
		p = e.slice(r, i);
	}
	for (; Le(e.charCodeAt(i));) i++;
	if (i === t) return {
...
function qn(e, i) {
	...
	if (r !== null && t !== null) {
		...
		if (n !== l) return n - l > 0;
		if (s !== p) return (s ?? "").localeCompare(p ?? "") > 0;
	}
...
function Zr(e, { theme: i }, r) {
	...
	if (Object.hasOwn(i, "fontFamily")) {
		let t = 5;
		{
			let n = je(i.fontFamily.sans);
			n && e.theme.hasDefault("--font-sans") && (e.theme.add("--default-font-family", n, t), e.theme.add("--default-font-feature-settings", je(i.fontFamily.sans, "fontFeatureSettings") ?? "normal", t), e.theme.add("--default-font-variation-settings", je(i.fontFamily.sans, "fontVariationSettings") ?? "normal", t));
		}
		{
			let n = je(i.fontFamily.mono);
			n && e.theme.hasDefault("--font-mono") && (e.theme.add("--default-mono-font-family", n, t), e.theme.add("--default-mono-font-feature-settings", je(i.fontFamily.mono, "fontFeatureSettings") ?? "normal", t), e.theme.add("--default-mono-font-variation-settings", je(i.fontFamily.mono, "fontVariationSettings") ?? "normal", t));
		}
	}
	return i;
}
...
function Me(e) {
	...
	for (let t of e) if (!Qn.test(t)) return null;
	let r = Jn[e[0]];
	return r && (e = e.slice(), e[0] = r), e.map((t, n, s) => t === "1" && n !== s.length - 1 ? "" : t).map((t, n) => (t = t.replaceAll(".", "_"), (n === 0 || t.startsWith("-") || t === "lineHeight") && (t = t.replace(/([a-z])([A-Z])/g, (l, p, f) => `${p}-${f.toLowerCase()}`)), t)).filter((t, n) => t !== "DEFAULT" || n !== e.length - 1).join("-");
}
function Xn(e) {
...
function kt(e, i = null, r = !0) {
	let [t, n] = tt(M(e), i, r);
	return t ? F(n) : e;
}
function tt(e, i = null, r = !0) {
	let t = !1;
	return _(e, { exit(n, s) {
		if (n.kind === "word" && n.value !== "0") {
			let l = Qr(n.value, i, r);
			if (l === null || l === n.value) return;
			if (l === "0" && s.parent?.kind === "function") {
				let p = Qr(n.value, i, !1);
				return p === null ? void 0 : (t = !0, V.ReplaceSkip(ne(p)));
			}
			return t = !0, V.ReplaceSkip(ne(l));
		} else if (n.kind === "function" && (n.value === "calc" || n.value === "")) {
			if (n.nodes.length !== 5 || n.nodes[2].kind !== "word") return;
			let l = n.nodes[0], p = n.nodes[2].value, f = n.nodes[4], c = l.kind === "word" ? le.get(l.value) : null, m = f.kind === "word" ? le.get(f.value) : null;
			if (p === "*" && (c?.[0] === 0 && c?.[1] === null || m?.[0] === 0 && m?.[1] === null)) return t = !0, V.ReplaceSkip(ne("0"));
			if (p === "*" && c?.[0] === 0 && c?.[1] !== null && m?.[1] === null) return t = !0, s.parent?.kind === "function" ? V.ReplaceSkip(ne(`0${c[1]}`)) : V.ReplaceSkip(ne("0"));
			if (p === "*" && m?.[0] === 0 && m?.[1] !== null && c?.[1] === null) return t = !0, s.parent?.kind === "function" ? V.ReplaceSkip(ne(`0${m[1]}`)) : V.ReplaceSkip(ne("0"));
			if (p === "*") {
				if (c?.[0] === 1 && c?.[1] === null) return t = !0, V.ReplaceSkip(f);
				if (m?.[0] === 1 && m?.[1] === null) return t = !0, V.ReplaceSkip(l);
			}
			if (p === "*" || p === "+") {
				let d = c ?? m, u = c === null ? l : m === null ? f : null;
				if (d !== null && u !== null && u.kind === "function" && (u.value === "calc" || u.value === "") && u.nodes.length === 5 && u.nodes[2].kind === "word" && u.nodes[2].value === p) {
					let h = u.nodes[0], v = u.nodes[4], y = h.kind === "word" ? le.get(h.value) : null, b = v.kind === "word" ? le.get(v.value) : null, N = y ?? b, A = y === null ? h : b === null ? v : null;
					if (N !== null && A !== null) {
						if (p === "*" && !(d[1] === null && N[1] === null || d[1] === null && N[1] !== null || d[1] !== null && N[1] === null) || p === "+" && d[1] !== N[1]) return;
						let k;
						switch (p) {
							case "*":
								k = `${d[0] * N[0]}${d[1] ?? N[1] ?? ""}`;
						...
						if (t = !0, p === "*" && k === "1") return V.ReplaceSkip(A);
						let D = {
							kind: "function",
							value: n.value,
							nodes: [
			...
			switch (p) {
				case "*":
					if (c[1] === m[1] || c[1] === null && m[1] !== null || c[1] !== null && m[1] === null) return t = !0, V.ReplaceSkip(ne(`${c[0] * m[0]}${c[1] ?? m[1] ?? ""}`));
					break;
				case "+":
					if (c[1] === m[1]) return t = !0, V.ReplaceSkip(ne(`${c[0] + m[0]}${c[1] ?? ""}`));
					break;
				case "-":
					if (c[1] === m[1]) return t = !0, V.ReplaceSkip(ne(`${c[0] - m[0]}${c[1] ?? ""}`));
					break;
				case "/":
					if (m[0] !== 0 && (c[1] === null && m[1] === null || c[1] !== null && m[1] === null)) {
						let d = c[0] / m[0];
						if (Math.round(d * 100) / 100 !== d) break;
						return t = !0, V.ReplaceSkip(ne(`${d}${c[1] ?? ""}`));
					}
					break;
			}
		}
...
function Ne(e, i = "top", r = "right", t = "bottom", n = "left") {
	return ri(`${e}-${i}`, `${e}-${r}`, `${e}-${t}`, `${e}-${n}`);
}
function ri(e = "top", i = "right", r = "bottom", t = "left") {
	return {
		1: [
			[e, 0],
			[i, 0],
...
var Xr = {
	...
	margin: Ne("margin"),
	padding: Ne("padding"),
	"scroll-margin": Ne("scroll-margin"),
	"scroll-padding": Ne("scroll-padding"),
	"border-width": Ne("border", "top-width", "right-width", "bottom-width", "left-width"),
	"border-style": Ne("border", "top-style", "right-style", "bottom-style", "left-style"),
	"border-color": Ne("border", "top-color", "right-color", "bottom-color", "left-color"),
	gap: se("row-gap", "column-gap"),
	overflow: se("overflow-x", "overflow-y"),
	"overscroll-behavior": se("overscroll-behavior-x", "overscroll-behavior-y")
}, ei = {
	"inset-block": se("top", "bottom"),
	"inset-inline": se("left", "right"),
	"margin-block": se("margin-top", "margin-bottom"),
	"margin-inline": se("margin-left", "margin-right"),
	"padding-block": se("padding-top", "padding-bottom"),
	"padding-inline": se("padding-left", "padding-right"),
	"scroll-margin-block": se("scroll-margin-top", "scroll-margin-bottom"),
	"scroll-margin-inline": se("scroll-margin-left", "scroll-margin-right"),
	"scroll-padding-block": se("scroll-padding-top", "scroll-padding-bottom"),
	"scroll-padding-inline": se("scroll-padding-left", "scroll-padding-right")
}, ti = {
...
function ii(e, i) {
	if (i & 2) {
		if (e.property in ei) {
			let r = d(e.value, " ");
			return ei[e.property][r.length]?.map(([t, n]) => o(t, r[n], e.important));
		}
		if (e.property in ti) return ti[e.property]?.map((r) => o(r, e.value, e.important));
	}
	if (e.property in Xr) {
		let r = d(e.value, " ");
		return Xr[e.property][r.length]?.map(([t, n]) => o(t, r[n], e.important));
	}
	return null;
}
function tl(e) {
...
function ue(e, i = !1) {
	...
	for (let t of e) switch (t.kind) {
		...
		case "compound":
			...
			break;
		case "list":
			r += t.nodes.map((n) => ue([n], i)).join(i ? "," : ", ");
			break;
	}
	return r;
}
var li = 92, ll = 93, oi = 41, ai = 58, si = 44, ol = 34, al = 46, ui = 62, Ht = 10, sl = 35, fi = 91, ci = 40, pi = 43, ul = 39, Zt = 32, Jt = 9, di = 126, fl = 38, cl = 42;
function Ee(e) {
	e = e.replaceAll(`\r
`, `
`);
	let i = [], r = i, t = !1, n = [], s = null, l = "", p;
	function f(m = r) {
		return m.length === 1 ? m[0] : t ? qt(m) : ni(m);
	}
	function c(m) {
		let d = r[r.length - 1];
		d?.kind === "compound" ? d.nodes.push(m) : d && d.kind !== "list" && d.kind !== "combinator" ? r[r.length - 1] = ni([d, m]) : r.push(m);
	}
	for (let m = 0; m < e.length; m++) {
		let d = e.charCodeAt(m);
		switch (d) {
			case si:
				for (l.length > 0 && (c(Ae(l)), l = ""); m + 1 < e.length && (p = e.charCodeAt(m + 1), !(p !== Ht && p !== Zt && p !== Jt)); m++);
				if (s) s.nodes.push(f()), r = [], t = !1;
				else {
					let v = il([f(r.splice(0))]);
					r.push(v), s = v, r = [], t = !1;
				}
				break;
			case ui:
			...
			case di: {
				l.length > 0 && (c(Ae(l)), l = "");
				let u = m, h = m + 1;
				for (; h < e.length && (p = e.charCodeAt(h), !(p !== ui && p !== Ht && p !== Zt && p !== pi && p !== Jt && p !== di)); h++);
				m = h - 1;
				let v = e.slice(u, h).trim();
				if (v === "" && (r.length === 0 || h >= e.length || e.charCodeAt(h) === si)) break;
				r.push(tl(v === "" ? " " : v)), t = !0;
				break;
			}
			case ci: {
				...
				if (l = "", u.value !== ":not" && u.value !== ":where" && u.value !== ":has" && u.value !== ":is") {
					let h = m + 1, v = 0;
					for (let b = m + 1; b < e.length; b++) {
						if (p = e.charCodeAt(b), p === ci) {
							v++;
							continue;
						}
						if (p === oi) {
					...
					let y = m;
					u.nodes.push(nl(e.slice(h, y))), l = "", m = y, c(u);
					break;
				}
				c(u), n.push({
					target: r,
			...
			case oi: {
				l.length > 0 && (c(Ae(l)), l = ""), s ? s.nodes.push(f()) : t && r.splice(0, r.length, qt(r.splice(0)));
				let u = n.pop();
			...
			case sl:
				...
				l.length > 0 && c(Ae(l)), l = e[m];
				break;
			case fi: {
				l.length > 0 && c(Ae(l)), l = "";
				let u = m, h = 0;
				for (let v = m + 1; v < e.length; v++) {
					if (p = e.charCodeAt(v), p === fi) {
						h++;
						continue;
					}
					if (p === ll) {
			...
			case ol: {
				let u = m;
				for (let h = m + 1; h < e.length; h++) if (p = e.charCodeAt(h), p === li) h += 1;
				else if (p === d) {
					m = h;
					break;
				}
	...
	return l.length > 0 && c(Ae(l)), s ? s.nodes.push(f()) : t && r.splice(0, r.length, qt(r.splice(0))), i;
}
function ce(e, i) {
...
function Qt(e, i) {
	let r = e;
	return r.storage[yi] ??= pl(), r.storage[ki] ??= gl(r), r.storage[bi] ??= wl(), r.storage[xi] ??= kl(), r.storage[Ai] ??= xl(), r.storage[er] ??= Tl(r), r.storage[At] ??= Rl(r, i), r.storage[ve] ??= Yl(r), r.storage[tr] ??= ql(), r.storage[Ct] ??= Hl(r), r.storage[rr] ??= Zl(r), r.storage[St] ??= Jl(r), r.storage[Ti] ??= Ql(r), r.storage[rt] ??= dl(r), r;
}
var yi = Symbol();
function pl() {
...
function dl(e) {
	return new U((i) => {
		let r = e.storage[ve].get(i);
		return function(n, s) {
			let l = typeof n == "string" ? n : e.printCandidate(n), p = r.get(l);
			if (typeof p != "string") return !1;
			let f = typeof s == "string" ? s : e.printCandidate(s), c = r.get(f);
			return typeof c != "string" ? !1 : p === c;
		};
	});
}
function ml(e, i) {
	let r = 0;
	return i?.collapse && (r |= 1), i?.logicalToPhysical && (r |= 2), Qt(e, i).storage[yi].get(i?.rem ?? null).get(r);
}
var ki = Symbol();
function gl(e) {
...
function hl(e, i, r) {
	let t = 0;
	return r?.collapse && (t |= 1), Qt(e).storage[ki].get(i).get(t);
}
function Xt(e, i, r) {
	let n = hl(e, ml(e, r), r), s = Qt(e), l = /* @__PURE__ */ new Set(), p = s.storage[bi].get(n);
	for (let f of i) l.add(p.get(f));
	return l.size <= 1 || !(n.features & 1) ? Array.from(l) : vl(n, Array.from(l));
}
function vl(e, i) {
	let r = e.designSystem, t = new U((p) => new U((f) => /* @__PURE__ */ new Set())), n = e.designSystem.theme.prefix ? `${e.designSystem.theme.prefix}:` : "";
	for (let p of i) {
		let f = d(p, ":"), c = f.pop(), m = c.endsWith("!");
		m && (c = c.slice(0, -1));
		let d$3 = f.length > 0 ? `${f.join(":")}:` : "", u = m ? "!" : "";
		t.get(d$3).get(u).add(`${n}${c}`);
	}
	let s = /* @__PURE__ */ new Set();
	for (let [p, f] of t.entries()) for (let [c, m] of f.entries()) for (let d of l(Array.from(m))) n && d.startsWith(n) && (d = d.slice(n.length)), s.add(`${p}${d}${c}`);
	return Array.from(s);
	function l(p) {
		let f = e.signatureOptions, c = r.storage[Ct].get(f), m = r.storage[tr].get(f), d = p.map((A) => c.get(A));
		if (d.some((A) => A.has("line-height"))) {
			let A = r.theme.keysInNamespaces(["--text"]);
			if (A.length > 0) {
				let k = /* @__PURE__ */ new Set(), D = /* @__PURE__ */ new Set();
				for (let P of d) if (P.has("line-height")) for (let z of P.get("line-height")) {
					if (D.has(z)) continue;
					D.add(z);
					let E = r.storage[At]?.get(z) ?? null;
					if (E !== null) if (de$1(E)) {
						k.add(E);
						for (let j of A) c.get(`text-${j}/${E}`);
					} else {
						k.add(z);
						for (let j of A) c.get(`text-${j}/[${z}]`);
					}
				}
				let O = /* @__PURE__ */ new Set();
				for (let P of d) if (P.has("font-size")) {
					for (let z of P.get("font-size")) if (!O.has(z)) {
						O.add(z);
						for (let E of k) de$1(E) ? c.get(`text-[${z}]/${E}`) : c.get(`text-[${z}]/[${E}]`);
					}
				}
			}
		}
		let u = new U((A) => {
			let k = new U((O) => new U((P) => /* @__PURE__ */ new Set())), D = new Set(c.get(A).keys());
			if (D.size === 0) return k;
			for (let O of pe(r, A)) if (!(O.kind !== "functional" || O.value === null)) {
				for (let P of r.utilities.keys("functional")) {
					if (P === O.root) continue;
					let z = Ci(r, {
						...Ke(O),
						root: P
					}), E = c.get(z);
					for (let [j, q] of E) if (D.has(j)) for (let G of q) k.get(j).get(G).add(z);
				}
				return k;
			}
			return k;
			...
			for (let O of A.keys()) {
				...
				for (let z of m.get(O).values()) for (let E of z) P.add(E);
				for (let z of A.get(O)) for (let E of u.get(p[k]).get(O).get(z)) P.add(E);
				if (D === null ? D = P : D = wi(D, P), D.size === 0) return D;
			}
			return D ?? /* @__PURE__ */ new Set();
		}), v = new U((A) => new Set([A]));
		for (let A = 0; A < h.length; A++) {
			let k = h[A];
			for (let D = A + 1; D < h.length; D++) {
				let O = h[D];
				for (let P of k) if (O.has(P)) {
					v.get(A).add(D), v.get(D).add(A);
					break;
				}
			}
		}
		if (v.size === 0) return p;
		let y = new U((A) => A.split(",").map(Number));
		for (let A of v.values()) {
			let k = Array.from(A).sort((D, O) => D - O);
			y.get(k.join(","));
		}
		let b = new Set(p), N = /* @__PURE__ */ new Set();
		for (let A of y.values()) for (let k of eo(A)) {
			if (k.some((P) => N.has(p[P]))) continue;
			let D = k.flatMap((P) => h[P]).reduce(wi), O = r.storage[ve].get(f).get(k.map((P) => p[P]).sort((P, z) => P.localeCompare(z)).join(" "));
			for (let P of D) if (r.storage[ve].get(f).get(P) === O) {
				b.add(P);
				for (let E of k) p[E] !== P && N.add(p[E]);
				break;
			}
		}
		for (let A of N) b.delete(A);
		return Array.from(b);
	}
}
var bi = Symbol();
function wl() {
	return new U((e) => {
		let i = e.designSystem, r = i.theme.prefix ? `${i.theme.prefix}:` : "", t = i.storage[xi].get(e), n = i.storage[Ai].get(e);
		return new U((s, l) => {
			for (let p of i.parseCandidate(s)) {
				let f = p.variants.slice().reverse().flatMap((d) => t.get(d)), c = p.important;
				if (c || f.length > 0) {
					...
					return i.theme.prefix !== null && f.length > 0 && (u = u.slice(r.length)), f.length > 0 && (u = `${f.map((h) => i.printVariant(h)).join(":")}:${u}`), c && (u += "!"), i.theme.prefix !== null && f.length > 0 && (u = `${r}${u}`), u;
				}
				let m = n.get(s);
				if (m !== s) return m;
			}
...
function kl() {
	return new U((e) => new U((i) => {
		let r = [i];
		for (let t of yl) for (let n of r.splice(0)) {
			let s = t(De(n), e);
			if (Array.isArray(s)) {
				r.push(...s);
				continue;
...
function Cl(e) {
	if (e.kind === "static" && e.root.startsWith("bg-gradient-to-")) {
		...
		return Al.includes(i) && (e.root = `bg-linear-to-${i}`), e;
	}
	return e;
}
function Vl(e, i) {
...
function Sl(e, i) {
	let r = i.designSystem.storage[er], t = Vt(e);
...
function $l(e, i) {
	return e.kind === "arbitrary" ? e.value = gi(e.value, i.designSystem) : e.kind === "functional" && e.value?.kind === "arbitrary" && (e.value.value = gi(e.value.value, i.designSystem)), e;
}
function gi(e, i) {
...
function Tl(e) {
	...
	function i(r) {
		function t(p, f = 0) {
			let c = M(p);
			if (f & 2) return [bt(c, l), null];
			let m = 0, d$4 = 0;
			if (_(c, (v) => {
				v.kind === "function" && v.value === "theme" && (m += 1, _(v.nodes, (y) => y.kind === "separator" && y.value.includes(",") ? V.Stop : y.kind === "word" && y.value === "/" ? (d$4 += 1, V.Stop) : V.Skip));
			}), m === 0) return [p, null];
			if (d$4 === 0) return [bt(c, s), null];
			if (d$4 > 1) return [bt(c, l), null];
			let u = null;
			return [bt(c, (v, y) => {
				let b = d(v, "/").map((N) => N.trim());
				if (b.length > 2) return null;
				if (c.length === 1 && b.length === 2 && f & 1) {
					let [N, A] = b;
					if (/^\d+%$/.test(A)) u = {
						kind: "named",
						value: A.slice(0, -1)
		...
		function s(p, f) {
			...
			if (m[0] === "spacing" && r.theme.get(["--spacing"])) {
				let d = m[1];
				return de$1(d) ? `--spacing(${d})` : null;
			}
			return null;
		}
		function l(p, f) {
			let c = d(p, "/").map((u) => u.trim());
			p = c.shift();
			let m = n(p, !1);
			if (!m) return null;
			let d$5 = c.length > 0 ? `/${c.join("/")}` : "";
			return f ? `--theme(${m}${d$5}, ${f})` : `--theme(${m}${d$5})`;
		}
		return t;
	}
}
function bt(e, i) {
	return _(e, (r, t) => {
		if (r.kind === "function" && r.value === "theme") {
			...
			s = Nl(s);
			let p = r.nodes.slice(l + 1), f = p.length > 0 ? i(s, F(p)) : i(s);
			if (f === null) return;
			{
				let c = t.index - 1;
				for (; c !== -1;) {
...
var At = Symbol(), Vi = 1536, El = Vi / 16;
function hi(e, i, r) {
...
function Pl(e, i) {
	...
	let r = i.designSystem, t = r.storage[rr].get(i.signatureOptions), n = r.storage[ve].get(i.signatureOptions), s = r.storage[rt].get(i.signatureOptions), l = r.printCandidate(e), p = n.get(l);
	if (typeof p != "string") return e;
	for (let c of f(p, e)) if (s(e, c) && Ol(r, e, c)) return c;
	return e;
	function* f(c, m) {
		let d = t.get(c);
		if (d.length > 1) {
			let u;
			for (let h of d) if (h[0] !== "-") {
				if (u) return;
				u = h;
			}
			if (u) for (let h of pe(r, u)) yield h;
			return;
		}
		if (d.length === 0 && m.modifier) {
			let u = {
				...m,
				modifier: null
			}, h = n.get(r.printCandidate(u));
			if (typeof h == "string") for (let v of f(h, u)) yield Object.assign({}, v, { modifier: m.modifier });
		}
		if (d.length === 1) for (let u of pe(r, d[0])) yield u;
		else if (d.length === 0) {
			let u = m.kind === "arbitrary" ? m.value : m.value?.value ?? null;
			if (u === null) return;
			if (i.signatureOptions.rem !== null && m.kind === "functional" && m.value?.kind === "arbitrary") {
				let y = r.storage[At]?.get(u) ?? null;
				y !== null && de$1(y) && hi(y, r, i.signatureOptions.rem) && (yield Object.assign({}, m, { value: {
					kind: "named",
					value: y,
					fraction: null
				} }));
			}
			let h = r.storage[At]?.get(u) ?? null, v = "";
			h !== null && h < 0 && (v = "-", h = Math.abs(h));
			for (let y of Array.from(r.utilities.keys("functional")).sort((b, N) => +(b[0] === "-") - +(N[0] === "-"))) {
				v && (y = `${v}${y}`);
				for (let b of pe(r, `${y}-${u}`)) yield b;
				if (m.modifier) for (let b of pe(r, `${y}-${u}${m.modifier}`)) yield b;
				if (h !== null && de$1(h) && hi(h, r, i.signatureOptions.rem)) {
					for (let b of pe(r, `${y}-${h}`)) yield b;
					if (m.modifier) for (let b of pe(r, `${y}-${h}${Xe(m.modifier)}`)) yield b;
				}
				for (let b of pe(r, `${y}-[${u}]`)) yield b;
				if (m.modifier) for (let b of pe(r, `${y}-[${u}]${Xe(m.modifier)}`)) yield b;
			}
		}
	}
}
...
`), s = !0;
	return _(M(t), (l) => {
		if (l.kind === "function" && l.value === "var") {
			let p = l.nodes[0].value;
			if (!new RegExp(`var\\(${p}[,)]\\s*`, "g").test(n) || n.includes(`${p}:`)) return s = !1, V.Stop;
		}
	}), s;
}
function _l(e, i) {
	...
	let r = i.designSystem, t = r.storage[rr].get(i.signatureOptions), n = r.storage[ve].get(i.signatureOptions), s = r.storage[rt].get(i.signatureOptions), l = r.printCandidate(e), p = n.get(l);
	if (typeof p != "string") return e;
	for (let c of f(p, e)) if (s(e, c)) return c;
	return e;
	function* f(c, m) {
		let d = t.get(c);
		if (d.length > 1) {
...
]), Dl = new Map([[/^(-)?start-(.*?)$/, "$1inset-s-$2"], [/^(-)?end-(.*?)$/, "$1inset-e-$2"]]);
function* Kl(e) {
	let i = Il.get(e);
	i && (yield i);
	for (let [r, t] of Dl) {
...
function Ul(e, i) {
	let r = i.designSystem, t = r.storage[rt].get(i.signatureOptions), n = Ci(r, e);
	for (let s of Kl(n)) {
		if (!t(e, s)) continue;
		let [l] = pe(r, s);
		return l;
...
function zl(e, i) {
	let r = i.designSystem, t = r.storage[St], n = r.storage[Ti], s = Vt(e);
	for (let [l] of s) {
		if (l.kind === "compound") continue;
		let p = r.printVariant(l), f = t.get(p);
		if (typeof f != "string") continue;
		let c = n.get(f);
		if (c.length !== 1) continue;
		let m = c[0], d = r.parseVariant(m);
		d !== null && ce(l, d);
	}
	return e;
}
...
function jl(e, i) {
	...
	let r = i.designSystem, t = r.storage[ve].get(i.signatureOptions), n = t.get(r.printCandidate(e));
	if (n === null) return e;
	for (let s of Si(e)) if (t.get(r.printCandidate({
		...e,
		value: s
...
function* Si(e, i = e.value?.value ?? "", r = /* @__PURE__ */ new Set()) {
	if (r.has(i)) return;
	if (r.add(i), yield {
		kind: "named",
		value: i,
...
function Fl(e, i) {
	let r = [e], t = i.designSystem, n = t.storage[St], s = Vt(e);
	for (let [l, p] of s) if (l.kind === "compound" && (l.root === "has" || l.root === "not" || l.root === "in") && l.modifier !== null && "modifier" in l.variant && (l.variant.modifier = l.modifier, l.modifier = null), l.kind === "arbitrary") {
		if (l.relative) continue;
		let f = Ee(l.selector);
		if (!vi(f)) continue;
		if (f.length === 1 && f[0].kind === "complex" && (f = f[0].nodes), p === null && f.length === 3 && f[0].kind === "selector" && f[0].value === "&" && f[1].kind === "combinator" && f[1].value === ">" && f[2].kind === "selector" && f[2].value === "*") {
			ce(l, t.parseVariant("*"));
			continue;
		}
		if (p === null && f.length === 3 && f[0].kind === "selector" && f[0].value === "&" && f[1].kind === "combinator" && f[1].value === " " && f[2].kind === "selector" && f[2].value === "*") {
			ce(l, t.parseVariant("**"));
			continue;
		}
		if (p === null && f.length === 1 && f[0].kind === "compound" && f[0].nodes.length === 2 && f[0].nodes[0].kind === "selector" && f[0].nodes[0].value === "&" && f[0].nodes[1].kind === "function" && f[0].nodes[1].value === ":has" && f[0].nodes[1].nodes.length === 1 && f[0].nodes[1].nodes[0].kind === "selector") {
			ce(l, t.parseVariant(`has-[${ue(f[0].nodes[1].nodes, !0)}]`));
			continue;
		}
		if (p === null && f.length === 3 && f[0].kind === "selector" && f[1].kind === "combinator" && f[1].value === " " && f[2].kind === "selector" && f[2].value === "&") {
			f.pop(), f.pop(), ce(l, t.parseVariant(`in-[${ue(f, !0)}]`));
			continue;
		}
		if (p === null && f[0].kind === "selector" && (f[0].value === "@media" || f[0].value === "@supports")) {
			let u = n.get(t.printVariant(l)), h = M(ue(f, !0)), v = !1;
			if (_(h, (y) => {
				if (y.kind === "word" && y.value === "not") return v = !0, V.Replace([]);
			}), h = M(F(h)), _(h, (y) => {
				y.kind === "separator" && y.value !== " " && y.value.trim() === "" && (y.value = " ");
			}), v) {
				let y = t.parseVariant(`not-[${F(h)}]`);
				if (y === null) continue;
				if (u === n.get(t.printVariant(y))) {
					ce(l, y);
					continue;
				}
			}
		...
		let c = null;
		p === null && f.length === 3 && f[0].kind === "selector" && f[0].value === "&" && f[1].kind === "combinator" && f[1].value === ">" && f[2].kind === "selector" && (f[2].value[0] === ":" || xt(f[2])) && (f = [f[2]], c = t.parseVariant("*")), p === null && f.length === 3 && f[0].kind === "selector" && f[0].value === "&" && f[1].kind === "combinator" && f[1].value === " " && f[2].kind === "selector" && (f[2].value[0] === ":" || xt(f[2])) && (f = [f[2]], c = t.parseVariant("**"));
		let m = f;
		if (_(m, {
			enter(u) {
		...
		if (d.kind === "function" && d.value === ":is") {
			if (!vi(d.nodes) || d.nodes.length !== 1 || d.nodes[0].kind === "selector" && !xt(d.nodes[0])) continue;
			d = d.nodes[0];
		}
		if (d.kind === "function" && d.value[0] === ":" || d.kind === "selector" && d.value[0] === ":") {
			let u$2 = d, h = !1;
			if (u$2.kind === "function" && u$2.value === ":not") {
				if (h = !0, u$2.nodes.length !== 1 || u$2.nodes[0].kind !== "selector" && u$2.nodes[0].kind !== "function" || u$2.nodes[0].value[0] !== ":") continue;
				u$2 = u$2.nodes[0];
			}
			let v = ((b) => {
				if (b === ":nth-child" && u$2.kind === "function" && u$2.nodes.length === 1 && u$2.nodes[0].kind === "value" && u$2.nodes[0].value === "odd") return h ? (h = !1, "even") : "odd";
				if (b === ":nth-child" && u$2.kind === "function" && u$2.nodes.length === 1 && u$2.nodes[0].kind === "value" && u$2.nodes[0].value === "even") return h ? (h = !1, "odd") : "even";
				for (let [N, A] of [
					[":nth-child", "nth"],
					[":nth-last-child", "nth-last"],
					[":nth-of-type", "nth-of-type"],
					[":nth-last-of-type", "nth-of-last-type"]
				]) if (b === N && u$2.kind === "function" && u$2.nodes.length === 1) return u$2.nodes.length === 1 && u$2.nodes[0].kind === "value" && u(u$2.nodes[0].value) ? `${A}-${u$2.nodes[0].value}` : `${A}-[${ue(u$2.nodes, !0)}]`;
				if (h) {
					if (n.get(t.printVariant(l)) === n.get(`not-[${b}]`)) return `[&${b}]`;
				}
				return null;
			})(u$2.value);
			if (v === null) {
			...
			h && (v = `not-${v}`);
			let y = t.parseVariant(v);
			if (y === null) continue;
			ce(l, y);
		} else if (d.kind === "selector" && xt(d)) {
			let u = qr(d.value);
			if (u === null) continue;
			if (u.attribute.startsWith("data-")) {
				let h = u.attribute.slice(5);
				ce(l, {
					kind: "functional",
					root: "data",
					modifier: null,
					value: u.value === null ? {
						...
						kind: "arbitrary",
						value: `${h}${u.operator}${u.quote ?? ""}${u.value}${u.quote ?? ""}${u.sensitivity ? ` ${u.sensitivity}` : ""}`
					}
				});
...
function Wl(e, i) {
	if (e.kind !== "functional" || e.value?.kind !== "arbitrary") return e;
	let t = i.designSystem.storage[rt].get(i.signatureOptions), n = M(e.value.value);
	if (n.length === 1 && n[0].kind === "function" && n[0].value === "calc") {
		let [s, l] = tt(n, null, !1);
		if (s) {
			let p = Ke(e);
			p.value.value = F(l), t(e, p) && (e = p, n = l);
		}
	}
	if (e.root[0] === "-") {
		if (n.length === 1 && n[0].kind === "function" && n[0].value === "var") return e;
		let [l, p] = tt(M(`calc(${e.value.value} * -1)`), null, !1);
		if (l) {
			let f = Ke(e);
			f.root = f.root.slice(1), f.value.value = F(p), t(e, f) && (e = f, n = p);
		}
	}
	if (n.length === 1 && n[0].kind === "function" && n[0].value === "calc") {
		let s = n[0].nodes;
		if (s.length === 5 && s[1].kind === "separator" && s[1].value === " " && s[2].kind === "word" && s[2].value === "*" && s[3].kind === "separator" && s[3].value === " ") {
			...
			if (l) {
				let p = Ke(e);
				p.root = `-${e.root}`, p.value.value = F([l]), t(e, p) && (e = p);
			}
		}
	}
	return e;
...
function Bl(e, i) {
	...
	let r = i.designSystem, t = r.storage[ve].get(i.signatureOptions), n = t.get(r.printCandidate(e)), s = e.modifier;
	...
	return _(i, {
		enter(n, s) {
			if (n.kind === "declaration") {
				...
				if (n.property.startsWith("--tw-") && s.siblings.some((d) => d.kind === "declaration" && n.value === d.value && n.important === d.important && !d.property.startsWith("--tw-"))) return V.Replace([]);
				if (r.features & 1) {
					let d = ii(n, r.features);
					if (d) return V.Replace(d);
				}
				n.value.includes("var(") && (n.value = Gl(n.value, e));
				let [p, f] = tt(M(n.value), t), [c, m] = Hr(f);
				(p || c) && (n.value = F(m)), n.value = xe(n.value);
			} else {
			...
			if (n.kind === "rule" || n.kind === "at-rule") {
				if (n.nodes.length > 1) {
					...
					for (let l = n.nodes.length - 1; l >= 0; l--) {
						let p = n.nodes[l];
						p.kind === "declaration" && p.value !== void 0 && (s.has(p.property) && n.nodes.splice(l, 1), s.add(p.property));
					}
				}
...
function Gl(e, i) {
	...
	return _(t, (s) => {
		...
		let p = i.resolveThemeValue(l);
		if (!n.has(l) && (n.add(l), p !== void 0 && (s.nodes.length === 1 && (r = !0, s.nodes.push(...M(`,${p}`))), s.nodes.length >= 3))) {
			if (F(s.nodes) === `${s.nodes[0].value},${p}`) return r = !0, V.Replace(M(p));
		}
	}), r ? F(t) : e;
}
var tr = Symbol();
...
function Hl(e) {
	return new U((i) => new U((r) => {
		...
		try {
			_($i(e, e.compileAstNodes(n[0]).map((l) => re(l.node)), i), (l) => {
				l.kind === "declaration" && (t.get(l.property).add(l.value), e.storage[tr].get(i).get(l.property).get(l.value).add(r));
			});
		} catch {}
		return t;
	}));
...
function Zl(e) {
	return new U((i) => {
		let r = e.storage[ve].get(i), t = new U(() => []);
		for (let [n, s] of e.getClassList()) {
			let l = r.get(n);
			if (typeof l == "string") {
				if (n[0] === "-" && n.endsWith("-0")) {
					let p = r.get(n.slice(1));
					if (typeof p == "string" && l === p) continue;
				}
				t.get(l).push(n), e.storage[Ct].get(i).get(n);
				for (let p of s.modifiers) {
					if (de$1(p)) continue;
					let f = `${n}/${p}`, c = r.get(f);
					typeof c == "string" && (t.get(c).push(f), e.storage[Ct].get(i).get(f));
				}
			}
		}
		return t;
		...
		try {
			...
			return Ce(r, e), _(r, (n) => {
				if (n.kind === "at-rule" && n.params.includes(" ")) n.params = n.params.replaceAll(" ", "");
					...
					let s = Ee(n.selector), l = !1;
					_(s, (p) => {
						if (p.kind === "list" || p.kind === "combinator") l = !0;
						else if (p.kind === "function" && p.value === ":is") {
							if (p.nodes.length === 1) return l = !0, V.Replace(p.nodes);
							if (p.nodes.length === 2 && p.nodes[0].kind === "selector" && p.nodes[0].value === "*" && p.nodes[1].kind === "selector" && p.nodes[1].value[0] === ":") return l = !0, V.Replace(p.nodes[1]);
						} else p.kind === "function" && p.value[0] === ":" && p.nodes[0]?.kind === "selector" && p.nodes[0]?.value[0] === ":" && (l = !0, p.nodes.unshift({
							kind: "selector",
							value: "*"
						}));
					}), l && (n.selector = ue(s, !0));
...
function Ni(e) {
	...
	for (let n of e.utilities.keys("functional")) {
		...
		for (let l of s) for (let p of l.values) {
			let f = p !== null && ro.test(p), c = p === null ? n : `${n}-${p}`, m = i.get(c);
			if (m.utility = n, m.fraction ||= f, m.modifiers.push(...l.modifiers), l.supportsNegative) {
				let d = i.get(`-${c}`);
				d.utility = `-${n}`, d.fraction ||= f, d.modifiers.push(...l.modifiers);
			}
	...
	return r.sort((n, s) => yt(n.name, s.name)), io(r);
}
function io(e) {
	...
	for (let l of e) {
		...
		r || (r = {
			utility: p,
			items: []
		}, t.set(p, r)), p !== r.utility && (i.push(r), r = {
			utility: p,
			items: []
		}, t.set(p, r)), f ? n.get(p).push(l) : r.items.push(l);
	}
	...
	let s = [];
	for (let l of i) for (let p of l.items) s.push([p.name, { modifiers: p.modifiers }]);
	return s;
}
function Ei(e) {
	let i = [];
	for (let [t, n] of e.variants.entries()) {
		let p = function({ value: f, modifier: c } = {}) {
			let m = t;
			f && (m += s ? `-${f}` : f), c && (m += `/${c}`);
			let d = e.parseVariant(m);
			if (!d) return [];
			let u = H(".__placeholder__", []);
			if (Fe(u, d, e.variants) === null) return [];
			let h = [];
			return _(u.nodes, { exit(v, y) {
				if (v.kind !== "rule" && v.kind !== "at-rule" || v.nodes.length > 0) return;
				let b = y.path();
				b.push(v), b.sort((k, D) => {
					let O = k.kind === "at-rule", P = D.kind === "at-rule";
					return O && !P ? -1 : !O && P ? 1 : 0;
				});
				let N = b.flatMap((k) => k.kind === "rule" ? k.selector === "&" ? [] : [k.selector] : k.kind === "at-rule" ? [`${k.name} ${k.params}`] : []), A = "";
				for (let k = N.length - 1; k >= 0; k--) A = A === "" ? N[k] : `${N[k]} { ${A} }`;
				h.push(A);
			} }), h;
		};
...
function Ri(e, i) {
	let { astNodes: r, nodeSorting: t } = Ve(Array.from(i), e), n = new Map(i.map((l) => [l, null])), s = 0n;
	for (let l of r) {
		let p = t.get(l)?.candidate;
		p && n.set(p, n.get(p) ?? s++);
	}
...
var ir = class {
	...
	fromAst(i, r, t) {
		...
		_(r, (l) => {
			...
			let p = r.map(re);
			s && it(p, t), nr(p, l.nodes), l.nodes = p;
		}, { compounds: Pe(n) });
	}
...
function Oi(e) {
	let i = new ir();
	function r(c, m, { compounds: d } = {}) {
		d = d ?? Pe(m), i.static(c, (u) => {
			u.nodes = m.map((h) => J(h, u.nodes));
		}, { compounds: d });
	}
	...
	function t(c, m) {
		return m.map((d$6) => {
			if (c === "@container") {
				let u = M(d$6.trim());
				return u.length >= 1 && u[0].kind === "function" ? `not ${d$6}` : u.length >= 3 && u[0].kind === "word" && u[0].value === "not" && u[2].kind === "function" ? (u.splice(0, 2), F(u)) : u.length >= 5 && u[0].kind === "word" && u[2].kind === "word" && u[2].value === "not" && u[4].kind === "function" ? (u.splice(2, 2), F(u)) : u.length >= 3 && u[0].kind === "word" && u[0].value !== "not" && u[2].kind === "function" ? (u.splice(1, 0, {
					kind: "separator",
					value: " "
				}, {
					kind: "word",
				...
				d$6 = d$6.trim();
				let u = d(d$6, " ");
				return u[0] === "not" ? u.slice(1).join(" ") : `not ${d$6}`;
			}
		});
	}
	let n = [
	...
	function s(c) {
		for (let m of n) {
			...
			let d$7 = d(c.params, ",");
			return d$7.length > 1 ? null : (d$7 = t(c.name, d$7), B(c.name, d$7.join(", ")));
		}
		return null;
	}
	function l(c) {
		return c.includes("::") ? null : `&:not(${d(c, ",").map((d) => (d = d.replaceAll("&", "*"), d)).join(", ")})`;
	}
	i.compound("not", 3, (c, m) => {
		...
		if (_([c], (u, h) => {
			...
			let v = [], y = [], b = h.path();
			b.push(u);
			for (let A of b) A.kind === "at-rule" ? v.push(A) : A.kind === "rule" && y.push(A);
			if (v.length > 1) return V.Stop;
			if (y.length > 1) return V.Stop;
			let N = [];
			for (let A of y) {
				let k = l(A.selector);
				if (!k) return d = !1, V.Stop;
				N.push(H(k, []));
			}
			for (let A of v) {
				let k = s(A);
			...
			return Object.assign(c, H("&", N)), d = !0, V.Skip;
		}), c.kind === "rule" && c.selector === "&" && c.nodes.length === 1 && Object.assign(c, c.nodes[0]), !d) return null;
	}), i.suggest("not", () => Array.from(i.keys()).filter((c) => i.compoundsWith("not", c))), i.compound("group", 2, (c, m) => {
		if (m.variant.kind === "arbitrary" && m.variant.relative) return null;
		let d$8 = m.modifier ? `:where(.${e.prefix ? `${e.prefix}\\:` : ""}group\\/${m.modifier.value})` : `:where(.${e.prefix ? `${e.prefix}\\:` : ""}group)`, u = !1;
		if (_([c], (h, v) => {
			if (h.kind !== "rule") return V.Continue;
			for (let b of v.path()) if (b.kind === "rule") return u = !1, V.Stop;
			let y = h.selector.replaceAll("&", d$8);
			d(y, ",").length > 1 && (y = `:is(${y})`), h.selector = `&:is(${y} *)`, u = !0;
		}), !u) return null;
	}), i.suggest("group", () => Array.from(i.keys()).filter((c) => i.compoundsWith("group", c))), i.compound("peer", 2, (c, m) => {
		if (m.variant.kind === "arbitrary" && m.variant.relative) return null;
		let d$9 = m.modifier ? `:where(.${e.prefix ? `${e.prefix}\\:` : ""}peer\\/${m.modifier.value})` : `:where(.${e.prefix ? `${e.prefix}\\:` : ""}peer)`, u = !1;
		if (_([c], (h, v) => {
			if (h.kind !== "rule") return V.Continue;
			for (let b of v.path()) if (b.kind === "rule") return u = !1, V.Stop;
			let y = h.selector.replaceAll("&", d$9);
			d(y, ",").length > 1 && (y = `:is(${y})`), h.selector = `&:is(${y} ~ *)`, u = !0;
		}), !u) return null;
	...
	r("first", ["&:first-child"]), r("last", ["&:last-child"]), r("only", ["&:only-child"]), r("odd", ["&:nth-child(odd)"]), r("even", ["&:nth-child(even)"]), r("first-of-type", ["&:first-of-type"]), r("last-of-type", ["&:last-of-type"]), r("only-of-type", ["&:only-of-type"]), r("visited", ["&:visited"]), r("target", ["&:target"]), r("open", ["&:is([open], :popover-open, :open)"]), r("default", ["&:default"]), r("checked", ["&:checked"]), r("indeterminate", ["&:indeterminate"]), r("placeholder-shown", ["&:placeholder-shown"]), r("autofill", ["&:autofill"]), r("optional", ["&:optional"]), r("required", ["&:required"]), r("valid", ["&:valid"]), r("invalid", ["&:invalid"]), r("user-valid", ["&:user-valid"]), r("user-invalid", ["&:user-invalid"]), r("in-range", ["&:in-range"]), r("out-of-range", ["&:out-of-range"]), r("read-only", ["&:read-only"]), r("empty", ["&:empty"]), r("focus-within", ["&:focus-within"]), i.static("hover", (c) => {
	...
	}), r("focus", ["&:focus"]), r("focus-visible", ["&:focus-visible"]), r("active", ["&:active"]), r("enabled", ["&:enabled"]), r("disabled", ["&:disabled"]), r("inert", ["&:is([inert], [inert] *)"]), i.compound("in", 2, (c, m) => {
		if (m.modifier) return null;
		let d = !1;
		if (_([c], (u, h) => {
			if (u.kind !== "rule") return V.Continue;
			for (let v of h.path()) if (v.kind === "rule") return d = !1, V.Stop;
			u.selector = `:where(${u.selector.replaceAll("&", "*")}) &`, d = !0;
		}), !d) return null;
	}), i.suggest("in", () => Array.from(i.keys()).filter((c) => i.compoundsWith("in", c))), i.compound("has", 2, (c, m) => {
		if (m.modifier) return null;
		let d = !1;
		if (_([c], (u, h) => {
			if (u.kind !== "rule") return V.Continue;
			for (let v of h.path()) if (v.kind === "rule") return d = !1, V.Stop;
			u.selector = `&:has(${u.selector.replaceAll("&", "*")})`, d = !0;
		}), !d) return null;
	}), i.suggest("has", () => Array.from(i.keys()).filter((c) => i.compoundsWith("has", c))), i.functional("aria", (c, m) => {
		if (!m.value || m.modifier) return null;
		m.value.kind === "arbitrary" ? c.nodes = [H(`&[aria-${Pi(m.value.value)}]`, c.nodes)] : c.nodes = [H(`&[aria-${m.value.value}="true"]`, c.nodes)];
	}), i.suggest("aria", () => [
		"busy",
		"checked",
		"disabled",
		...
		"required",
		"selected"
	]), i.functional("data", (c, m) => {
		if (!m.value || m.modifier) return null;
		c.nodes = [H(`&[data-${Pi(m.value.value)}]`, c.nodes)];
	}), i.functional("nth", (c, m) => {
		if (!m.value || m.modifier || m.value.kind === "named" && !u(m.value.value)) return null;
		c.nodes = [H(`&:nth-child(${m.value.value})`, c.nodes)];
	}), i.functional("nth-last", (c, m) => {
		if (!m.value || m.modifier || m.value.kind === "named" && !u(m.value.value)) return null;
		c.nodes = [H(`&:nth-last-child(${m.value.value})`, c.nodes)];
	}), i.functional("nth-of-type", (c, m) => {
		if (!m.value || m.modifier || m.value.kind === "named" && !u(m.value.value)) return null;
		c.nodes = [H(`&:nth-of-type(${m.value.value})`, c.nodes)];
	}), i.functional("nth-last-of-type", (c, m) => {
		if (!m.value || m.modifier || m.value.kind === "named" && !u(m.value.value)) return null;
		c.nodes = [H(`&:nth-last-of-type(${m.value.value})`, c.nodes)];
	}), i.functional("supports", (c, m) => {
		if (!m.value || m.modifier) return null;
		let d = m.value.value;
		if (d === null) return null;
		if (/^[\w-]*\s*\(/.test(d)) {
			c.nodes = [B("@supports", d.replace(/\b(and|or|not)\b/g, " $1 "), c.nodes)];
			return;
		}
		d.includes(":") || (d = `${d}: var(--tw)`), (d[0] !== "(" || d[d.length - 1] !== ")") && (d = `(${d})`), c.nodes = [B("@supports", d, c.nodes)];
	...
	{
		let c = function(m, d, u, h) {
			if (m === d) return 0;
			let v = h.get(m);
			if (v === null) return u === "asc" ? -1 : 1;
			let y = h.get(d);
			return y === null ? u === "asc" ? 1 : -1 : Te(v, y, u);
		};
		{
			let m = e.namespace("--breakpoint"), d = new U((u) => {
				switch (u.kind) {
					case "static": return e.resolveValue(u.root, ["--breakpoint"]) ?? null;
					case "functional": {
						if (!u.value || u.modifier) return null;
						let h = null;
						return u.value.kind === "arbitrary" ? h = u.value.value : u.value.kind === "named" && (h = e.resolveValue(u.value.value, ["--breakpoint"])), !h || h.includes("var(") ? null : h;
					}
					case "arbitrary":
			...
			i.group(() => {
				i.functional("max", (u, h) => {
					if (h.modifier) return null;
					let v = d.get(h);
					if (v === null) return null;
					u.nodes = [B("@media", `(width < ${v})`, u.nodes)];
				}, { compounds: 1 });
			}, (u, h) => c(u, h, "desc", d)), i.suggest("max", () => Array.from(m.keys()).filter((u) => u !== null)), i.group(() => {
				for (let [u, h] of e.namespace("--breakpoint")) u !== null && i.static(u, (v) => {
					v.nodes = [B("@media", `(width >= ${h})`, v.nodes)];
				}, { compounds: 1 });
				i.functional("min", (u, h) => {
					if (h.modifier) return null;
					let v = d.get(h);
					if (v === null) return null;
					u.nodes = [B("@media", `(width >= ${v})`, u.nodes)];
				}, { compounds: 1 });
			}, (u, h) => c(u, h, "asc", d)), i.suggest("min", () => Array.from(m.keys()).filter((u) => u !== null));
		}
		{
			let m = e.namespace("--container"), d = new U((u) => {
				switch (u.kind) {
					case "functional": {
						if (u.value === null) return null;
						let h = null;
						return u.value.kind === "arbitrary" ? h = u.value.value : u.value.kind === "named" && (h = e.resolveValue(u.value.value, ["--container"])), !h || h.includes("var(") ? null : h;
					}
					case "static":
					case "arbitrary":
					case "compound": return null;
			...
			i.group(() => {
				i.functional("@max", (u, h) => {
					let v = d.get(h);
					if (v === null) return null;
					u.nodes = [B("@container", h.modifier ? `${h.modifier.value} (width < ${v})` : `(width < ${v})`, u.nodes)];
				}, { compounds: 1 });
			}, (u, h) => c(u, h, "desc", d)), i.suggest("@max", () => Array.from(m.keys()).filter((u) => u !== null)), i.group(() => {
				i.functional("@", (u, h) => {
					let v = d.get(h);
					if (v === null) return null;
					u.nodes = [B("@container", h.modifier ? `${h.modifier.value} (width >= ${v})` : `(width >= ${v})`, u.nodes)];
				}, { compounds: 1 }), i.functional("@min", (u, h) => {
					let v = d.get(h);
					if (v === null) return null;
					u.nodes = [B("@container", h.modifier ? `${h.modifier.value} (width >= ${v})` : `(width >= ${v})`, u.nodes)];
				}, { compounds: 1 });
			}, (u, h) => c(u, h, "asc", d)), i.suggest("@min", () => Array.from(m.keys()).filter((u) => u !== null)), i.suggest("@", () => Array.from(m.keys()).filter((u) => u !== null));
		}
	}
...
function it(e, i) {
	...
	return _(e, (t) => {
		...
		for (let [l, p] of s.entries()) {
			let f = H("&", l === s.length - 1 ? t.nodes : t.nodes.map(re)), c = d(p, ":");
			for (let m = c.length - 1; m >= 0; --m) {
				let d = c[m].trim();
				if (!d) throw new Error("Cannot use `@variant` with empty variant");
				let u = i.parseVariant(d);
				if (u === null) throw new Error(`Cannot use \`@variant\` with unknown variant: ${d}`);
				if (Fe(f, u, i.variants) === null) throw new Error(`Cannot use \`@variant\` with variant: ${d}`);
			}
			n.push(f);
		}
...
function _i(e, i) {
	let r = Fr(e), t = Oi(e), n = new U((d) => Kr(d, m)), s = new U((d) => Array.from(Dr(d, m))), l = new U((d) => new U((u) => {
		let h = Ii(u, m, d);
		try {
			let v = h.map((y) => y.node);
			Ue(v, m), it(v, m);
		} catch {
			return [];
		}
		...
		for (let u of dt(d)) e.markUsedVariable(u);
	});
	function f(d) {
		let u = [];
		for (let h of d) {
			let v = !0, { astNodes: y } = Ve([h], m, { onInvalidCandidate() {
				v = !1;
			} });
			i && _(y, (b) => (b.src ??= i, V.Continue)), y = $e(y, m, 0), u.push(v ? y : []);
		}
		return u;
	}
	function c(d) {
		return f(d).map((u) => u.length > 0 ? ae(u) : null);
	}
	let m = {
		theme: e,
		utilities: r,
		...
		compileAstNodes(d, u = 1) {
			return l.get(u).get(d);
		},
		printCandidate(d) {
			return zr(m, d);
		},
		...
		getVariantOrder() {
			...
			let u = /* @__PURE__ */ new Map(), h, v = 0;
			for (let y of d) y !== null && (h !== void 0 && this.variants.compare(h, y) !== 0 && v++, u.set(y, v), h = y);
			return u;
		},
		resolveThemeValue(d, u = !0) {
			let h = d.lastIndexOf("/"), v = null;
			h !== -1 && (v = d.slice(h + 1).trim(), d = d.slice(0, h).trim());
			let y = e.resolve(null, [d], u ? 1 : 0) ?? void 0;
			return v && y ? X(y, v) : y;
		},
		trackUsedVariables(d) {
			p.get(d);
		},
		canonicalizeCandidates(d, u) {
			return Xt(this, d, u);
		},
		storage: {}
	};
...
function Ve(e, i, { onInvalidCandidate: r, respectImportant: t } = {}) {
	...
	for (let [c, m] of l) {
		let d = !1;
		for (let u of m) {
			let h = i.compileAstNodes(u, p);
			if (h.length !== 0) {
				d = !0;
				for (let { node: v, propertySort: y } of h) {
					let b = 0n;
					for (let N of u.variants) b |= 1n << BigInt(f.get(N));
					n.set(v, {
						properties: y,
						variants: b,
						candidate: c
	...
	return s.sort((c, m) => {
		let d = n.get(c), u = n.get(m);
		if (d.variants - u.variants !== 0n) return Number(d.variants - u.variants);
		let h = 0;
		for (; h < d.properties.order.length && h < u.properties.order.length && d.properties.order[h] === u.properties.order[h];) h += 1;
		return (d.properties.order[h] ?? Infinity) - (u.properties.order[h] ?? Infinity) || u.properties.count - d.properties.count || yt(d.candidate, u.candidate);
	}), {
		astNodes: s,
		nodeSorting: n
	};
...
function Ii(e, i, r) {
	...
	for (let p of t) {
		...
		for (let m of e.variants) if (Fe(c, m, i.variants) === null) return [];
		s.push({
			node: c,
			propertySort: f
		});
...
function Fe(e, i, r, t = 0) {
	if (i.kind === "arbitrary") {
		if (i.relative && t === 0) return null;
		e.nodes = [J(i.selector, e.nodes)];
		return;
	}
	let { applyFn: n } = r.get(i.root);
	if (i.kind === "compound") {
		let l = B("@slot");
		if (Fe(l, i.variant, r, t + 1) === null || i.root === "not" && l.nodes.length > 1) return null;
...
function no(e, i) {
	if (e.kind === "arbitrary") {
		let l = e.value;
		return e.modifier && (l = te(l, e.modifier, i.theme)), l === null ? [] : [[o(e.property, l)]];
	}
	let r = i.utilities.get(e.root) ?? [], t = [], n = r.filter((l) => !Di(l));
	for (let l of n) {
...
function Ki(e) {
	for (let i of e) i.kind !== "at-root" && (i.kind === "declaration" ? i.important = !0 : (i.kind === "rule" || i.kind === "at-rule") && Ki(i.nodes));
}
function lo(e) {
	...
	for (; t.length > 0;) {
		...
		if (s.kind === "declaration") {
			...
			if (s.property === "--tw-sort") {
				let p = lr.indexOf(s.value ?? "");
				if (p !== -1) {
					i.add(p), n = !0;
					continue;
				}
			}
			let l = lr.indexOf(s.property);
			l !== -1 && i.add(l);
...
function Ce(e, i) {
	let r = 0, t = J("&", e), n = /* @__PURE__ */ new Set(), s = new U(() => /* @__PURE__ */ new Set()), l = new U(() => /* @__PURE__ */ new Set());
	_([t], (d, u) => {
		if (d.kind === "at-rule") {
			if (d.name === "@keyframes") return _(d.nodes, (h) => {
				if (h.kind === "at-rule" && h.name === "@apply") throw new Error("You cannot use `@apply` inside `@keyframes`.");
			}), V.Skip;
			if (d.name === "@utility") {
				let h = d.params.replace(/-\*$/, "");
				l.get(h).add(d), _(d.nodes, (v) => {
					if (!(v.kind !== "at-rule" || v.name !== "@apply")) {
						n.add(d);
						for (let y of Ui(v, i)) s.get(d).add(y);
					}
				});
				return;
			}
			if (d.name === "@apply") {
				...
				r |= 1, n.add(u.parent);
				for (let h of Ui(d, i)) for (let v of u.path()) n.has(v) && s.get(v).add(h);
			}
		}
	});
	let p = /* @__PURE__ */ new Set(), f = [], c = /* @__PURE__ */ new Set();
	function m(d, u = []) {
		if (!p.has(d)) {
			if (c.has(d)) {
				let h = u[(u.indexOf(d) + 1) % u.length];
				throw d.kind === "at-rule" && d.name === "@utility" && h.kind === "at-rule" && h.name === "@utility" && _(d.nodes, (v) => {
					if (v.kind !== "at-rule" || v.name !== "@apply") return;
					let y = v.params.split(/\s+/g);
					for (let b of y) for (let N of i.parseCandidate(b)) switch (N.kind) {
						case "arbitrary": break;
						case "static":
						case "functional":
							if (h.params.replace(/-\*$/, "") === N.root) throw new Error(`You cannot \`@apply\` the \`${b}\` utility here because it creates a circular dependency.`);
							break;
						default:
					}
...
${ae([h])}`);
			...
			c.add(d);
			for (let h of s.get(d)) for (let v of l.get(h)) u.push(d), m(v, u), u.pop();
			p.add(d), c.delete(d), f.push(d);
		}
	}
	for (let d of n) m(d);
	for (let d$10 of f) "nodes" in d$10 && _(d$10.nodes, (u) => {
		if (u.kind !== "at-rule" || u.name !== "@apply") return;
		let h = u.params.split(/(\s+)/g), v = {}, y = [], b = [], N = 0;
		for (let [k, D] of h.entries()) k % 2 === 0 && (D[0] === "-" && D[1] === "-" ? b.push(D) : y.push(D), v[D] = N), N += D.length;
		if (b.length) {
			if (y.length === 0) return V.Skip;
			let k = b.join(" ");
			throw new Error(`You cannot use \`@apply\` with both mixins and utilities. Please move \`@apply ${k}\` into a separate rule.`);
		}
		if (u.nodes.length > 0 && y.length) {
			let k = y.join(" ");
			throw new Error(`The rule \`@apply ${k}\` must not have a body.`);
		}
		{
			let D = Ve(Object.keys(v), i, {
				respectImportant: !1,
				onInvalidCandidate: (E) => {
					...
					if (j.length > 1) {
						...
						if (i.candidatesToCss([q])[0]) {
							let G = i.candidatesToCss(j.map((ie) => `${ie}:[--tw-variant-check:1]`)), ee = j.filter((ie, a) => G[a] === null);
							if (ee.length > 0) {
								if (ee.length === 1) throw new Error(`Cannot apply utility class \`${E}\` because the ${ee.map((ie) => `\`${ie}\``)} variant does not exist.`);
								{
									...
									throw new Error(`Cannot apply utility class \`${E}\` because the ${ie.format(ee.map((a) => `\`${a}\``))} variants do not exist.`);
								}
							}
						}
					}
			...
			}), O = u.src, P = D.astNodes.map((E) => {
				let j = D.nodeSorting.get(E)?.candidate, q = j ? v[j] : void 0;
				if (E = re(E), !O || !j || q === void 0) return _([E], (ee) => {
					ee.src = O;
				}), E;
				let G = [
					O[0],
				...
				return G[1] += 7 + q, G[2] = G[1] + j.length, _([E], (ee) => {
					ee.src = G;
				}), E;
			}), z = [];
			for (let E of P) if (E.kind === "rule") for (let j of E.nodes) z.push(j);
			else z.push(E);
			return V.Replace(z);
		}
	});
...
async function or(e, i, r, t = 0, n = !1) {
	let s = 0, l = [];
	return _(e, (p) => {
		if (p.kind === "at-rule" && (p.name === "@import" || p.name === "@reference")) {
			let f = oo(M(p.params));
			if (f === null) return;
			p.name === "@reference" && (f.media = "reference"), s |= 2;
			let { uri: c, layer: m, media: d, supports: u } = f;
			...
			return l.push((async () => {
				...
				let v = await r(c, i), y = Se(v.content, { from: n ? v.path : void 0 });
				await or(y, v.base, r, t + 1, n), h.nodes = ao(p, [he({ base: v.base }, y)], m, d, u);
			})()), V.ReplaceSkip(h);
		}
...
function nt(e, i, r, t = []) {
	for (let n of i) if (n != null) for (let s of Reflect.ownKeys(n)) {
		t.push(s);
		let l = r(e[s], n[s], t);
		l !== void 0 ? e[s] = l : !We(e[s]) || !We(n[s]) ? e[s] = n[s] : e[s] = nt({}, [e[s], n[s]], r, t), t.pop();
	}
	return e;
}
function Tt(e, i, r) {
	return function(n, s) {
		let l = n.lastIndexOf("/"), p = null;
		l !== -1 && (p = n.slice(l + 1).trim(), n = n.slice(0, l).trim());
		let f = (() => {
			let c = Re(n), [m, d] = so(e.theme, c), u = r(zi(i() ?? {}, c) ?? null);
			if (typeof u == "string" && (u = u.replace("<alpha-value>", "1")), typeof m != "object") return typeof d != "object" && d & 4 ? u ?? m : m;
			if (u !== null && typeof u == "object" && !Array.isArray(u)) {
				let h = nt({}, [u], (v, y) => y);
				if (m === null && Object.hasOwn(u, "__CSS_VALUES__")) {
					let v = {};
					for (let y in u.__CSS_VALUES__) v[y] = u[y], delete h[y];
					m = v;
				}
				for (let v in m) v !== "__CSS_VALUES__" && (u?.__CSS_VALUES__?.[v] & 4 && zi(h, v.split("-")) !== void 0 || (h[a(v)] = m[v]));
				return h;
			}
			if (Array.isArray(m) && Array.isArray(d) && Array.isArray(u)) {
				let h = m[0], v = m[1];
				d[0] & 4 && (h = u[0] ?? h);
				for (let y of Object.keys(v)) d[1][y] & 4 && (v[y] = u[1][y] ?? v[y]);
				return [h, v];
			}
			return m ?? u;
		})();
		return p && typeof f == "string" && (f = X(f, p)), f ?? s;
	};
}
function so(e, i) {
	if (i.length === 1 && i[0].startsWith("--")) return [e.get([i[0]]), e.getOptions(i[0])];
	let r = Me(i), t = /* @__PURE__ */ new Map(), n = new U(() => /* @__PURE__ */ new Map()), s = e.namespace(`--${r}`);
	if (s.size === 0) return [null, 0];
	let l = /* @__PURE__ */ new Map();
	for (let [m, d] of s) {
		if (!m || !m.includes("--")) {
			t.set(m, d), l.set(m, e.getOptions(m ? `--${r}-${m}` : `--${r}`));
			continue;
		}
		let u = m.indexOf("--"), h = m.slice(0, u), v = m.slice(u + 2);
		v = v.replace(/-([a-z])/g, (y, b) => b.toUpperCase()), n.get(h === "" ? null : h).set(v, [d, e.getOptions(`--${r}${m}`)]);
	}
	let p = e.getOptions(`--${r}`);
	for (let [m, d] of n) {
		let u = t.get(m);
		if (typeof u != "string") continue;
		let h = {}, v = {};
		for (let [y, [b, N]] of d) h[y] = b, v[y] = N;
		t.set(m, [u, h]), l.set(m, [p, v]);
	}
	let f = {}, c = {};
	for (let [m, d] of t) Li(f, [m ?? "DEFAULT"], d);
	for (let [m, d] of l) Li(c, [m ?? "DEFAULT"], d);
...
function ar({ designSystem: e, ast: i, resolvedConfig: r, featuresRef: t, referenceMode: n, src: s }) {
	let l = {
		addBase(p) {
			if (n) return;
			let f = we(p);
		...
		addVariant(p, f) {
			if (!$t.test(p)) throw new Error(`\`addVariant('${p}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes, or underscore characters and start with a lowercase letter or number.`);
			if (typeof f == "string") {
				if (f.includes(":merge(")) return;
			} else if (Array.isArray(f)) {
				if (f.some((m) => m.includes(":merge("))) return;
			} else if (typeof f == "object") {
				let m = function(d, u) {
					return Object.entries(d).some(([h, v]) => h.includes(u) || typeof v == "object" && m(v, u));
				};
				if (m(f, ":merge(")) return;
			}
			typeof f == "string" || Array.isArray(f) ? e.variants.static(p, (m) => {
				m.nodes = Mi(f, m.nodes);
			}, { compounds: Pe(typeof f == "string" ? [f] : f) }) : typeof f == "object" && e.variants.fromAst(p, we(f), e);
		},
		matchVariant(p, f, c) {
			function m(u, h, v) {
				return Mi(f(u, { modifier: h?.value ?? null }), v);
			}
			try {
				let u = f("a", { modifier: null });
				if (typeof u == "string" && u.includes(":merge(")) return;
				if (Array.isArray(u) && u.some((h) => h.includes(":merge("))) return;
			} catch {}
			let d = Object.keys(c?.values ?? {});
			e.variants.group(() => {
				e.variants.functional(p, (u, h) => {
					if (!h.value) {
						if (c?.values && "DEFAULT" in c.values) {
							u.nodes = m(c.values.DEFAULT, h.modifier, u.nodes);
							return;
						}
						return null;
					}
					if (h.value.kind === "arbitrary") u.nodes = m(h.value.value, h.modifier, u.nodes);
					else if (h.value.kind === "named" && c?.values) {
						if (!Object.hasOwn(c.values, h.value.value)) return null;
						let v = c.values[h.value.value];
						if (typeof v != "string") return null;
						u.nodes = m(v, h.modifier, u.nodes);
					} else return null;
				});
			}, (u, h) => {
				if (u.kind !== "functional" || h.kind !== "functional") return 0;
				...
				let A = d.indexOf(v), k = d.indexOf(y);
				return A = A === -1 ? d.length : A, k = k === -1 ? d.length : k, A !== k ? A - k : b < N ? -1 : 1;
			}), e.variants.suggest(p, () => Object.keys(c?.values ?? {}).filter((u) => u !== "DEFAULT"));
		},
		addUtilities(p) {
			p = Array.isArray(p) ? p : [p];
			let f = p.flatMap((m) => Object.entries(m));
			f = f.flatMap(([m, d$11]) => d(m, ",").map((u) => [u.trim(), d$11]));
			let c = new U(() => []);
			for (let [m, d] of f) {
				...
				let u = Ee(m), h = !1;
				if (_(u, (v) => {
					if (v.kind === "selector" && v.value[0] === "." && ji.test(v.value.slice(1))) {
						let y = v.value;
						v.value = "&";
						let b = ue(u), N = y.slice(1), A = b === "&" ? we(d) : [J(b, we(d))];
						c.get(N).push(...A), h = !0, v.value = y;
						return;
					}
					if (v.kind === "function" && v.value === ":not") return V.Skip;
				}), !h) throw new Error(`\`addUtilities({ '${m}' : \u2026 })\` defines an invalid utility selector. Utilities must be a single class name and start with a lowercase letter, eg. \`.scrollbar-none\`.`);
			}
			for (let [m, d] of c) e.theme.prefix && _(d, (u) => {
				if (u.kind === "rule") {
					let h = Ee(u.selector);
					_(h, (v) => {
						v.kind === "selector" && v.value[0] === "." && (v.value = `.${e.theme.prefix}\\:${v.value.slice(1)}`);
					}), u.selector = ue(h);
				}
			}), e.utilities.static(m, (u) => {
				let h = d.map(re);
				return Fi(h, m, u.raw), t.current |= Ce(h, e), h;
			});
		},
		matchUtilities(p, f) {
			let c = f?.type ? Array.isArray(f?.type) ? f.type : [f.type] : ["any"];
			for (let [d, u] of Object.entries(p)) {
				let h = function({ negative: v }) {
					return (y) => {
						if (y.value?.kind === "arbitrary" && c.length > 0 && !c.includes("any") && (y.value.dataType && !c.includes(y.value.dataType) || !y.value.dataType && !ge(y.value.value, c))) return;
						let b = c.includes("color"), N = null, A = !1;
						{
							let O = f?.values ?? {};
							b && (O = Object.assign({
								inherit: "inherit",
								transparent: "transparent",
								current: "currentcolor"
							}, O)), y.value ? y.value.kind === "arbitrary" ? N = y.value.value : y.value.fraction && Object.hasOwn(O, y.value.fraction) ? (N = O[y.value.fraction], A = !0) : Object.hasOwn(O, y.value.value) ? N = O[y.value.value] : O.__BARE_VALUE__ && (N = O.__BARE_VALUE__(y.value) ?? null, A = (y.value.fraction !== null && N?.includes("/")) ?? !1) : N = O.DEFAULT ?? null;
						}
						if (N === null) return;
						let k;
						{
							let O = f?.modifiers ?? null;
							y.modifier ? O === "any" || y.modifier.kind === "arbitrary" ? k = y.modifier.value : O && Object.hasOwn(O, y.modifier.value) ? k = O[y.modifier.value] : b && !Number.isNaN(Number(y.modifier.value)) ? k = `${y.modifier.value}%` : k = null : k = null;
						}
						if (y.modifier && k === null && !A) return y.value?.kind === "arbitrary" ? null : void 0;
						b && k !== null && (N = X(N, k)), v && (N = `calc(${N} * -1)`);
						let D = we(u(N, { modifier: k }));
						return Fi(D, d, y.raw), t.current |= Ce(D, e), D;
					};
				};
				if (!ji.test(d)) throw new Error(`\`matchUtilities({ '${d}' : \u2026 })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);
				f?.supportsNegativeValues && e.utilities.functional(`-${d}`, h({ negative: !0 }), { types: c }), e.utilities.functional(d, h({ negative: !1 }), { types: c }), e.utilities.suggest(d, () => {
					let v = f?.values ?? {}, y = new Set(Object.keys(v));
					y.delete("__BARE_VALUE__"), y.delete("__CSS_VALUES__"), y.has("DEFAULT") && (y.delete("DEFAULT"), y.add(null));
					let b = f?.modifiers ?? {}, N = b === "any" ? [] : Object.keys(b);
					return [{
...
function we(e) {
	...
	for (let [t, n] of r) if (n != null && n !== !1) if (typeof n != "object") {
		...
		i.push(o(t, String(n)));
	} else if (Array.isArray(n)) for (let s of n) typeof s == "string" ? i.push(o(t, s)) : i.push(J(t, we(s)));
	else i.push(J(t, we(n)));
	return i;
}
function Mi(e, i) {
	return (typeof e == "string" ? [e] : e).flatMap((t) => {
		if (t.trim().endsWith("}")) {
			let s = Se(t.replace("}", "{@slot}}"));
			return nr(s, i), s;
		} else return J(t, i);
	});
}
...
function Wi(e, i) {
	for (let r of uo(i)) e.theme.addKeyframes(r);
}
function uo(e) {
	let i = [];
	if ("keyframes" in e.theme) for (let [r, t] of Object.entries(e.theme.keyframes)) i.push(B("@keyframes", r, we(t)));
	return i;
}
function Bi(e) {
	return { theme: {
...
function co(e, i) {
	if (Array.isArray(e) && We(e[0])) return e.concat(i);
	if (Array.isArray(i) && We(i[0]) && We(e)) return [e, ...i];
	if (Array.isArray(i)) return i;
}
function sr(e, { config: i, base: r, path: t, reference: n, src: s }) {
	let l = [];
	...
	for (let c of l) e.plugins.push(c), c.config && sr(e, {
		path: t,
		base: r,
		config: c.config,
	...
	let p = i.content ?? [], f = Array.isArray(p) ? p : p.files;
...
function po(e) {
	let i = /* @__PURE__ */ new Set(), r = Tt(e.design, () => e.theme, n), t = Object.assign(r, {
		theme: r,
		colors: l$1
	});
	function n(s) {
...
function mo({ center: e, padding: i, screens: r }, t) {
	let n = [], s = null;
	if (e && n.push(o("margin-inline", "auto")), (typeof i == "string" || typeof i == "object" && i !== null && "DEFAULT" in i) && n.push(o("padding-inline", typeof i == "string" ? i : i.DEFAULT)), typeof r == "object" && r !== null) {
		s = /* @__PURE__ */ new Map();
		let l = Array.from(t.theme.namespace("--breakpoint").entries());
		if (l.sort((p, f) => Te(p[1], f[1], "asc")), l.length > 0) {
			let [p] = l[0];
			n.push(B("@media", `(width >= --theme(--breakpoint-${p}))`, [o("max-width", "none")]));
		}
		for (let [p, f] of Object.entries(r)) {
			if (typeof f == "object") if ("min" in f) f = f.min;
			else continue;
			s.set(p, B("@media", `(width >= ${f})`, [o("max-width", f)]));
		}
	}
	if (typeof i == "object" && i !== null) {
		let l = Object.entries(i).filter(([p]) => p !== "DEFAULT").map(([p, f]) => [
			p,
			t.theme.resolveValue(p, ["--breakpoint"]),
			f
		]).filter(Boolean);
		l.sort((p, f) => Te(p[1], f[1], "asc"));
		for (let [p, , f] of l) if (s && s.has(p)) s.get(p).nodes.push(o("padding-inline", f));
		else {
			if (s) continue;
			n.push(B("@media", `(width >= theme(--breakpoint-${p}))`, [o("padding-inline", f)]));
		}
	}
	if (s) for (let [, l] of s) n.push(l);
	return n;
}
function Gi({ addVariant: e, config: i }) {
...
function qi(e) {
	for (let [r, t] of [
		...
		["l", "left"],
		["tl", "top left"]
	]) e.utilities.suggest(`bg-gradient-to-${r}`, () => []), e.utilities.static(`bg-gradient-to-${r}`, () => [o("--tw-gradient-position", `to ${t} in oklab`), o("background-image", "linear-gradient(var(--tw-gradient-stops))")]);
		...
		let n = function({ negative: s }) {
			return (l) => {
				...
				if (l.value.kind === "arbitrary") {
					...
					let f = l.value.value;
					return [o(t, s ? `calc(${f} * -1)` : f)];
				}
				let p = e.theme.resolve(l.value.fraction ?? l.value.value, ["--inset", "--spacing"]);
				if (p === null && l.value.fraction) {
					let [f, c] = d(l.value.fraction, "/");
					if (!u(f) || !u(c)) return;
					p = `calc(${l.value.fraction} * 100%)`;
				}
				if (p === null && s) {
					let f = e.theme.resolve(null, ["--spacing"]);
					if (f && de$1(l.value.value) && (p = `calc(${f} * -${l.value.value})`, p !== null)) return [o(t, p)];
				}
				if (p === null) {
					let f = e.theme.resolve(null, ["--spacing"]);
					f && de$1(l.value.value) && (p = `calc(${f} * ${l.value.value})`);
				}
				if (p !== null) return [o(t, s ? `calc(${p} * -1)` : p)];
			};
		};
		e.utilities.static(`${r}-auto`, () => [o(t, "auto")]), e.utilities.static(`${r}-full`, () => [o(t, "100%")]), e.utilities.static(`-${r}-full`, () => [o(t, "-100%")]), e.utilities.static(`${r}-px`, () => [o(t, "1px")]), e.utilities.static(`-${r}-px`, () => [o(t, "-1px")]), e.utilities.functional(`-${r}`, n({ negative: !0 })), e.utilities.functional(r, n({ negative: !1 }));
	}
}
function Hi(e, i) {
	...
	for (let [l, p] of Object.entries(r)) {
		let u = function(h) {
			i.variants.static(l, (v) => {
				v.nodes = [B("@media", d, v.nodes)];
			}, { order: h });
		};
	...
	if (n.length !== 0) {
		...
		i.variants.compareFns = new Map(Array.from(i.variants.compareFns).map(([l, p]) => (l > t && (l += n.length), [l, p])));
		for (let [l, p] of n.entries()) p(t + l + 1);
	}
}
function go(e) {
...
function Zi(e, i) {
	...
	if (Object.keys(r).length > 0) {
		let s = i.variants.get("aria"), l = s?.applyFn, p = s?.compounds;
		i.variants.functional("aria", (f, c) => {
			let m = c.value;
			return m && m.kind === "named" && m.value in r ? l?.(f, {
				...c,
				value: {
					kind: "arbitrary",
					value: r[m.value]
	...
	if (Object.keys(t).length > 0) {
		let s = i.variants.get("supports"), l = s?.applyFn, p = s?.compounds;
		i.variants.functional("supports", (f, c) => {
			let m = c.value;
			return m && m.kind === "named" && m.value in t ? l?.(f, {
				...c,
				value: {
					kind: "arbitrary",
					value: t[m.value]
	...
	if (Object.keys(n).length > 0) {
		let s = i.variants.get("data"), l = s?.applyFn, p = s?.compounds;
		i.variants.functional("data", (f, c) => {
			let m = c.value;
			return m && m.kind === "named" && m.value in n ? l?.(f, {
				...c,
				value: {
					kind: "arbitrary",
					value: n[m.value]
...
var ho = /^[a-z]+$/;
async function Qi({ designSystem: e, base: i, ast: r, loadModule: t, sources: n }) {
	let s = 0, l = [], p = [];
	_(r, (d$12, u) => {
		if (d$12.kind !== "at-rule") return;
		let h = Je(u);
		if (d$12.name === "@plugin") {
			if (h.parent !== null) throw new Error("`@plugin` cannot be nested.");
			let v = d$12.params.slice(1, -1);
...
\`@plugin\` options must be a flat list of declarations.`);
				...
				let N = b.value, A = d(N, ",").map((k) => {
					if (k = k.trim(), k === "null") return null;
					if (k === "true") return !0;
					if (k === "false") return !1;
					if (Number.isNaN(Number(k))) {
						if (k[0] === "\"" && k[k.length - 1] === "\"" || k[0] === "'" && k[k.length - 1] === "'") return k.slice(1, -1);
						if (k[0] === "{" && k[k.length - 1] === "}") throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${ae([b]).trim()}\` is not supported.
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
			...
			return l.push([{
				id: v,
				base: h.context.base,
				reference: !!h.context.reference,
				src: d$12.src
			}, Object.keys(y).length > 0 ? y : null]), s |= 4, V.Replace([]);
		}
		if (d$12.name === "@config") {
			if (d$12.nodes.length > 0) throw new Error("`@config` cannot have a body.");
			if (h.parent !== null) throw new Error("`@config` cannot be nested.");
			return p.push({
	...
	if (e.resolveThemeValue = function(u, h) {
		return u.startsWith("--") ? f(u, h) : (s |= Ji({
			designSystem: e,
			base: i,
			ast: r,
			sources: n,
			configs: [],
			pluginDetails: []
		}), e.resolveThemeValue(u, h));
	}, !l.length && !p.length) return 0;
	let [c, m] = await Promise.all([Promise.all(p.map(async ({ id: d, base: u, reference: h, src: v }) => {
		let y = await t(d, u, "config");
		return {
			path: d,
			base: y.base,
			config: y.module,
	...
	})), Promise.all(l.map(async ([{ id: d, base: u, reference: h, src: v }, y]) => {
		let b = await t(d, u, "plugin");
		return {
			path: d,
			base: b.base,
			plugin: b.module,
...
function Ji({ designSystem: e, base: i, ast: r, sources: t, configs: n, pluginDetails: s }) {
	let l = 0, f = [...s.map((y) => {
		if (!y.options) return {
	...
	]), { resolvedConfig: m, replacedThemeKeys: d } = ur(e, f), u = {
		designSystem: e,
		ast: r,
		resolvedConfig: c,
	...
	e.resolveThemeValue = function(b, N) {
		if (b[0] === "-" && b[1] === "-") return v(b, N);
		let A = h.theme(b, void 0);
		if (Array.isArray(A) && A.length === 2) return A[0];
		if (Array.isArray(A)) return A.join(", ");
		if (typeof A == "object" && A !== null && "DEFAULT" in A) return A.DEFAULT;
		if (typeof A == "string") return A;
	};
	for (let { handler: y, reference: b, src: N } of c.plugins) y(ar({
		...u,
		referenceMode: b ?? !1,
		src: N
	}));
	if (Zr(e, m, d), Wi(e, m), Zi(m, e), Hi(m, e), Yi(m, e), !e.theme.prefix && c.prefix) {
		if (c.prefix.endsWith("-") && (c.prefix = c.prefix.slice(0, -1), console.warn(`The prefix "${c.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only and is written as a variant before all utilities. We have fixed up the prefix for you. Remove the trailing \`-\` to silence this warning.`)), !ho.test(c.prefix)) throw new Error(`The prefix "${c.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
	...
	if (!e.important && c.important === !0 && (e.important = !0), typeof c.important == "string") {
		...
		_(r, (b, N) => {
			...
			let A = Je(N);
			return A.parent?.kind === "rule" && A.parent.selector === y ? V.Stop : V.ReplaceStop(H(y, [b]));
		});
	}
	for (let y of c.blocklist) e.invalidCandidates.add(y);
...
This feature is not currently supported.`);
		let b = !1;
		y.pattern[0] == "!" && (b = !0, y.pattern = y.pattern.slice(1)), t.push({
			...y,
			negated: b
		});
	}
...
function Xi({ ast: e }) {
	let i = new U((n) => at(n.code)), r = new U((n) => ({
		url: n.file,
		content: n.code,
		ignore: !1
	})), t = {
	...
	_(e, (n) => {
		...
		let s = r.get(n.src[0]);
		if (!s.content) return;
		let l = i.get(n.src[0]), p = i.get(n.dst[0]), f = s.content.slice(n.src[1], n.src[2]), c = 0;
		for (let u of f.split(`
`)) {
			if (u.trim() !== "") {
				let h = l.find(n.src[1] + c), v = p.find(n.dst[1]);
				t.mappings.push({
					name: null,
					originalPosition: {
						source: s,
		...
		let m = l.find(n.src[2]), d = p.find(n.dst[2]);
		t.mappings.push({
			name: null,
			originalPosition: {
				source: s,
...
function Nt(e) {
	...
	let p = n.slice(1, l), f = n.slice(l + 1), c;
	vo(p) ? c = wo(p) : c = d(p, ","), c = c.flatMap((d) => Nt(d));
	let m = Nt(f);
	for (let d of m) for (let u of c) r.push(t + u + d);
	return r;
}
function vo(e) {
	return en.test(e);
...
function tn(e, i) {
	...
	function s(l, p = []) {
		if (e.has(l) && !r.has(l)) {
			t.has(l) && i.onCircularDependency?.(p, l), t.add(l);
			for (let f of e.get(l) ?? []) p.push(l), s(f, p), p.pop();
...
var yo = /^[a-z]+$/, Ut = ((n) => (n[n.None = 0] = "None", n[n.AtProperty = 1] = "AtProperty", n[n.ColorMix = 2] = "ColorMix", n[n.All = 3] = "All", n))(Ut || {});
function ko() {
...
async function rn(e, { base: i = "", from: r, loadModule: t = ko, loadStylesheet: n = bo } = {}) {
	let s = 0;
	e = [he({ base: i }, e)], s |= await or(e, i, n, 0, r !== void 0);
	let l = null, p$1 = new p(), f = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), m = [], d$13 = null, u = null, h$2 = [], v = [], y = [], b = [], N = null;
	_(e, (k, D) => {
		if (k.kind !== "at-rule") return;
		let O = Je(D);
		if (k.name === "@tailwind" && (k.params === "utilities" || k.params.startsWith("utilities"))) {
			if (u !== null) return V.Replace([]);
			if (O.context.reference) return V.Replace([]);
			let P = d(k.params, " ");
			for (let z of P) if (z.startsWith("source(")) {
				...
				N = {
					base: O.context.sourceBase ?? O.context.base,
					pattern: E.slice(1, -1)
				};
			}
			u = k, s |= 16;
		...
		if (k.name === "@utility") {
			if (O.parent !== null) throw new Error("`@utility` cannot be nested.");
		...
		if (k.name === "@source") {
			...
			if (O.parent !== null) throw new Error("`@source` cannot be nested.");
			let P = !1, z = !1, E = k.params;
			if (E[0] === "n" && E.startsWith("not ") && (P = !0, E = E.slice(4)), E[0] === "i" && E.startsWith("inline(") && (z = !0, E = E.slice(7, -1).trim()), E[0] === "\"" && E[E.length - 1] !== "\"" || E[0] === "'" && E[E.length - 1] !== "'" || E[0] !== "'" && E[0] !== "\"") throw new Error("`@source` paths must be quoted.");
			let j = E.slice(1, -1);
			if (z) {
				let q = P ? b : y, G = d(j, " ");
				for (let ee of G) for (let ie of Nt(ee)) q.push(ie);
			} else v.push({
				base: O.context.base,
				pattern: j,
				negated: P
		...
		if (k.name === "@variant" && (O.parent === null ? k.nodes.length === 0 ? k.name = "@custom-variant" : (_(k.nodes, (P) => {
			if (P.kind === "at-rule" && P.name === "@slot") return k.name = "@custom-variant", V.Stop;
		}), k.name === "@variant" && h$2.push(k)) : h$2.push(k)), k.name === "@custom-variant") {
			if (O.parent !== null) throw new Error("`@custom-variant` cannot be nested.");
			let [P, z] = d(k.params, " ");
			if (!$t.test(P)) throw new Error(`\`@custom-variant ${P}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes, or underscore characters and start with a lowercase letter or number.`);
			if (k.nodes.length > 0 && z) throw new Error(`\`@custom-variant ${P}\` cannot have both a selector and a body.`);
			if (k.nodes.length === 0) {
				if (!z) throw new Error(`\`@custom-variant ${P}\` has no selector or body.`);
				let E = d(z.slice(1, -1), ",");
				if (E.length === 0 || E.some((G) => G.trim() === "")) throw new Error(`\`@custom-variant ${P} (${E.join(",")})\` selector is invalid.`);
				let j = [], q = [];
				for (let G of E) G = G.trim(), G[0] === "@" ? j.push(G) : q.push(G);
				f.set(P, (G) => {
					G.variants.static(P, (ee) => {
						let ie = [];
						q.length > 0 && ie.push(H(q.join(", "), ee.nodes));
						for (let a of j) ie.push(J(a, ee.nodes));
						ee.nodes = ie;
					}, { compounds: Pe([...q, ...j]) });
				}), c.set(P, /* @__PURE__ */ new Set());
			} else {
				let E = /* @__PURE__ */ new Set();
				_(k.nodes, (j) => {
					j.kind === "at-rule" && j.name === "@variant" && E.add(j.params);
				}), f.set(P, (j) => {
					j.variants.fromAst(P, k.nodes, j);
				}), c.set(P, E);
			}
			return V.ReplaceSkip([]);
		}
		if (k.name === "@media") {
			let P = d(k.params, " "), z = [];
			for (let E of P) if (E.startsWith("source(")) {
				let j = E.slice(7, -1);
				_(k.nodes, (q) => {
					if (q.kind === "at-rule" && q.name === "@tailwind" && q.params === "utilities") return q.params += ` source(${j})`, V.ReplaceStop([he({ sourceBase: O.context.base }, [q])]);
				});
			...
			} else E === "important" ? l = !0 : E === "reference" ? k.nodes = [he({ reference: !0 }, k.nodes)] : z.push(E);
			if (z.length > 0) k.params = z.join(" ");
			else if (P.length > 0) return V.Replace(k.nodes);
			return V.Continue;
		}
		if (k.name === "@theme") {
			let [P, z] = xo(k.params);
			if (s |= 64, O.context.reference && (P |= 2), z) {
				if (!yo.test(z)) throw new Error(`The prefix "${z}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
				p$1.prefix = z;
			}
			return _(k.nodes, (E) => {
				if (E.kind === "at-rule" && E.name === "@keyframes") return p$1.addKeyframes(E), V.Skip;
				if (E.kind === "comment") return;
				if (E.kind === "declaration" && E.property.startsWith("--")) {
					p$1.add(a(E.property), E.value ?? "", P, E.src);
					return;
				}
				let j = ae([B(k.name, k.params, [E])]).split(`
`).map((q, G, ee) => `${G === 0 || G >= ee.length - 2 ? " " : ">"} ${q}`).join(`
`);
				throw new Error(`\`@theme\` blocks must only contain custom properties or \`@keyframes\`.

${j}`);
			}), d$13 ? V.ReplaceSkip([]) : (d$13 = H(":root, :host", []), d$13.src = k.src, V.ReplaceSkip(d$13));
		}
	});
	let A = _i(p$1, u?.src);
	...
	for (let k of f.keys()) A.variants.static(k, () => {});
	for (let k of tn(c, { onCircularDependency(D, O) {
		let P = ae(D.map((z, E) => B("@custom-variant", z, [B("@variant", D[E + 1] ?? O, [])]))).replaceAll(";", " { … }").replace(`@custom-variant ${O} {`, `@custom-variant ${O} { /* \u2190 */`);
...
${P}`);
	...
	if (d$13) {
		let k = [];
		for (let [O, P] of A.theme.entries()) {
			if (P.options & 2) continue;
			let z = o(h(O), P.value);
			z.src = P.src, k.push(z);
		}
		let D = A.theme.getKeyframes();
		for (let O of D) e.push(he({ theme: !0 }, [Y([O])]));
		d$13.nodes = [he({ theme: !0 }, k)];
	}
	if (s |= it(e, A), s |= Ue(e, A), s |= Ce(e, A), u) {
		let k = u;
		k.kind = "context", k.context = {};
	}
	return _(e, (k) => {
		if (k.kind === "at-rule") return k.name === "@utility" ? V.Replace([]) : V.Skip;
	}), {
		designSystem: A,
		ast: e,
		sources: v,
...
async function Ao(e, i = {}) {
	let { designSystem: r, ast: t, sources: n, root: s, utilitiesNode: l, features: p, inlineCandidates: f } = await rn(e, i);
	t.unshift(pt(`! tailwindcss v${mr} | MIT License | https://tailwindcss.com `));
	function c(v) {
		r.invalidCandidates.add(v);
	}
	let m = /* @__PURE__ */ new Set(), d = null, u = 0, h = !1;
	for (let v of f) r.invalidCandidates.has(v) || (m.add(v), h = !0);
	return {
		sources: n,
		root: s,
		features: p,
		build(v) {
			if (p === 0) return e;
			if (!l) return d ??= $e(t, r, i.polyfills), d;
			let y = h, b = !1;
			h = !1;
			let N = m.size;
			for (let k of v) if (!r.invalidCandidates.has(k)) if (k[0] === "-" && k[1] === "-") {
				let D = r.theme.markUsedVariable(k);
				y ||= D, b ||= D;
			} else m.add(k), y ||= m.size !== N;
			if (!y) return d ??= $e(t, r, i.polyfills), d;
			let A = Ve(m, r, { onInvalidCandidate: c }).astNodes;
			return i.from && _(A, (k) => {
				k.src ??= l.src;
			}), !b && u === A.length ? (d ??= $e(t, r, i.polyfills), d) : (u = A.length, l.nodes = A, d = $e(t, r, i.polyfills), d);
		}
	};
}
async function Ef(e, i = {}) {
	let r = Se(e, { from: i.from }), t = await Ao(r, i), n = r, s = e;
	return {
		...t,
		build(l) {
			let p = t.build(l);
			return p === n || (s = ae(p, !!i.from), n = p), s;
		},
		buildSourceMap() {
			return Xi({ ast: n });
		}
...
async function Rf(e, i = {}) {
	return (await rn(Se(e, { from: i.from }), i)).designSystem;
}
function Co() {
...
//#endregion
export { ze as Features, Ut as Polyfills, Rf as __unstable__loadDesignSystem, Ef as compile, Ao as compileAst, Co as default };
